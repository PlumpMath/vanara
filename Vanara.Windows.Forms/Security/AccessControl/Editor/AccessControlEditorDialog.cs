...
namespace Vanara.Windows.Forms
{
	...
	/// <summary>
	/// Displays a property sheet that contains a basic security property page. This property page
	/// enables the user to view and edit the access rights allowed or denied by the ACEs in an
	/// object's DACL.
	/// </summary>
	...
	public class AccessControlEditorDialog : CommonDialog
	{
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_RESET_DACL_TREE); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_RESET_DACL_TREE, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_EDIT_AUDITS); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_EDIT_AUDITS, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_EDIT_OWNER); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_EDIT_OWNER, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_RESET_SACL_TREE); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_RESET_SACL_TREE, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_AUDITS_ELEVATION_REQUIRED); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_AUDITS_ELEVATION_REQUIRED, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_PAGE_TITLE); }
			private set { SetFlag(SI_OBJECT_INFO_Flags.SI_PAGE_TITLE, value); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_NO_TREE_APPLY); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_NO_TREE_APPLY, value, true); if (value) ShowAdvancedButton = true; }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_NO_ACL_PROTECT); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_NO_ACL_PROTECT, value); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_EDIT_PROPERTIES); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_EDIT_PROPERTIES, value, true); if (value) ShowAdvancedButton = true; }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_PERMS_ELEVATION_REQUIRED); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_PERMS_ELEVATION_REQUIRED, value, true); }
		}
		...
		{
			get { return flags; }
			set { flags = value; if (iSecInfo != null) iSecInfo.objectInfo.dwFlags = value; }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_NO_ADDITIONAL_PERMISSION); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_NO_ADDITIONAL_PERMISSION, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_MAY_WRITE); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_MAY_WRITE, value); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_OBJECT_GUID); }
			private set { SetFlag(SI_OBJECT_INFO_Flags.SI_OBJECT_GUID, value); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_CONTAINER); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_CONTAINER, value); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_OWNER_ELEVATION_REQUIRED); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_OWNER_ELEVATION_REQUIRED, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_OWNER_READONLY); }
			set { var opt = value ? SI_OBJECT_INFO_Flags.SI_OWNER_READONLY | SI_OBJECT_INFO_Flags.SI_EDIT_OWNER : SI_OBJECT_INFO_Flags.SI_OWNER_READONLY; SetFlag(opt, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_OWNER_RECURSE); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_OWNER_RECURSE, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_READONLY); }
			set { if (value) SetFlag(SI_OBJECT_INFO_Flags.SI_VIEW_ONLY, false); SetFlag(SI_OBJECT_INFO_Flags.SI_READONLY, value); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_SERVER_IS_DC); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_SERVER_IS_DC, value); }
		}
		...
		public string ServerName
		{
			...
			set { serverName = value; if (iSecInfo != null) iSecInfo.objectInfo.pszServerName = value; }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_ADVANCED); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_ADVANCED, value); if (value && PageType == SecurityPageType.BasicPermissions) SetFlag(SI_OBJECT_INFO_Flags.SI_VIEW_ONLY, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_RESET_SACL); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_RESET_SACL, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_RESET); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_RESET, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_EDIT_EFFECTIVE); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_EDIT_EFFECTIVE, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_RESET_OWNER); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_RESET_OWNER, value, true); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_RESET_DACL); }
			set { SetFlag(SI_OBJECT_INFO_Flags.SI_RESET_DACL, value, true); }
		}
		...
		{
			get { return title; }
			set { title = value; if (iSecInfo != null) iSecInfo.objectInfo.pszPageTitle = value; CustomPageTitle = !string.IsNullOrEmpty(value); }
		}
		...
		{
			get { return HasFlag(SI_OBJECT_INFO_Flags.SI_VIEW_ONLY); }
			set { if (value) SetFlag(SI_OBJECT_INFO_Flags.SI_READONLY, false); SetFlag(SI_OBJECT_INFO_Flags.SI_VIEW_ONLY, value); }
		}

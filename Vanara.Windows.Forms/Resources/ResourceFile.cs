...
namespace Vanara.Resources
{
	public class ResourceFile : IDisposable
	{
		...
		public byte[] GetResourceData(ResourceName name, ResourceType resourceType)
		{
		...
		public IList<ResourceName> GetResourceNames(ResourceName type) => EnumResourceNames(hLib, type);

		protected virtual Bitmap GetBitmap(ResourceName name, Size size)
		{
		...
		protected virtual Icon GetGroupIcon(ResourceName name)
		{
		...
		protected virtual Icon GetIcon(ResourceName name, Size size)
		{
		...
		public class GroupIconResIndexer
		{
			...
			internal delegate Icon IndexerGetter(ResourceName name);
		...
		public class ImageResIndexer<T>
		{
			...
			internal delegate T IndexerGetter(ResourceName name, Size size);

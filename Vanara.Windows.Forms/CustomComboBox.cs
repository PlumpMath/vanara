...
namespace Vanara.Windows.Forms
{
	...
	public abstract class CustomComboBox : ComboBox, IPopupControlHost
	{
		...
		[Browsable(false)]
		public Control DropDownControl { get { return dropDownCtrl; } set { AssignControl(value); } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new int DropDownHeight { get { return base.DropDownHeight; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new int DropDownWidth { get { return base.DropDownWidth; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new int MaxDropDownItems { get { return base.MaxDropDownItems; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new int SelectedIndex { get { return base.SelectedIndex; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new object SelectedItem { get { return base.SelectedItem; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new string SelectedText { get { return base.SelectedText; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new object SelectedValue { get { return base.SelectedValue; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new int SelectionLength { get { return base.SelectionLength; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new int SelectionStart { get { return base.SelectionStart; } set { } }
		...
		[DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		[Browsable(false), ReadOnly(true)]
		public new bool Sorted { get { return base.Sorted; } set { } }
		...
		public override bool PreProcessMessage(ref Message m)
		{
			...
			{
				if (HIWORD(m.WParam) == (int)ComCtl32.ComboBoxNotification.CBN_DROPDOWN)
					return false;
			}
		...
		protected override void WndProc(ref Message m)
		{
			...
			if (m.Msg == (int)WindowMessage.WM_REFLECT + (int)WindowMessage.WM_COMMAND && DropDownControl != null)
			{
				...
				{
					case (int)ComCtl32.ComboBoxNotification.CBN_DROPDOWN:
						AutoDropDown();
						return;

					case (int)ComCtl32.ComboBoxNotification.CBN_CLOSEUP:

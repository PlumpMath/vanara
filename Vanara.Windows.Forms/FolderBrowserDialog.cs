...
namespace Vanara.Windows.Forms
{
	...
	public class FolderBrowserDialog : CommonDialog
	{
		...
		private static ComCtl32.IImageList sysImgList;
		...
		public KnownFolders RootFolder
		{
			...
			{
				rootFolder = value;
				try { rootPidl = ((KNOWNFOLDERID_Enum)RootFolder).PIDL(); }
				catch
				{
		...
		private static Icon GetSystemImageListIcon(int idx)
		{
			...
			try
			{
				if (sysImgList == null)
				{
					...
					sysImgList = (ComCtl32.IImageList)Marshal.GetTypedObjectForIUnknown(ptr, typeof(ComCtl32.IImageList));
				}
				var hIcon = sysImgList.GetIcon(idx, ComCtl32.IMAGELISTDRAWFLAGS.ILD_TRANSPARENT);

...
namespace Vanara.Windows.Forms
{
	...
	public class DisabledItemComboBox : ComboBox
	{
		...
		{
			var cbi = ComCtl32.COMBOBOXINFO.FromHandle(new HandleRef(this, Handle));
		...
		private class ListBoxNativeWindow : NativeWindow
		{
			...
			{
				var n = SendMessage(new HandleRef(this, Handle), 0x1a9 /* LB_ITEMFROMPOINT */, IntPtr.Zero, MAKELPARAM(x, y));
				if (HIWORD(n) == 0)
					return LOWORD(n);
				return -1;
			}

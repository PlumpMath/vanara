...
namespace Vanara.Windows.Forms
{
	...
	public class SplitButton : VistaButtonBase
	{
		...
		{
			get { return GetSplitStyle(SplitButtonInfoStyle.BCSS_NOSPLIT); }
		...
		{
			get { return GetSplitStyle(SplitButtonInfoStyle.BCSS_ALIGNLEFT) ? LeftRightAlignment.Left : LeftRightAlignment.Right; }
		...
		{
			get { return splitButtonImageList; }
			set
			{
		...
		{
			get { return GetSplitStyle(SplitButtonInfoStyle.BCSS_STRETCH); }
			set { SetSplitStyle(SplitButtonInfoStyle.BCSS_STRETCH, value); }
		}

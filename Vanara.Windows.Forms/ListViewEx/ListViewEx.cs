...
using static Vanara.Interop.User32;
...
namespace Vanara.Windows.Forms
{
	...
	public partial class ListViewEx : ListView
	{
			...
			set
			{
				if (watermarkImage != value)
				{
					...
					this.CallWhenHandleValid(c =>
					{
						...
						Vanara.Interop.User32.SendMessage(Handle, ListViewMessage.SetBkImage, 0, bki);
					});
				}
			}
		}
		...
		public int MeasureTextWidth(string text) => Vanara.Interop.User32.SendMessage(new HandleRef(this, Handle), (uint)ListViewMessage.GetStringWidth, IntPtr.Zero, text).ToInt32();
		...
		{
			this.CallWhenHandleValid(c => Vanara.Interop.User32.SendMessage(c.Handle, ListViewMessage.SetItem, 0, lvItem));
		}

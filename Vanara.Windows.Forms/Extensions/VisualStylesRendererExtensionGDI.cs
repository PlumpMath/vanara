...
namespace Vanara.Extensions
{
	public static partial class ExtensionMethods
	{
		...
		private static User32.DrawTextFlags FromTFF(TextFormatFlags tff) => (User32.DrawTextFlags)(int)tff;
		...
		public static Font GetFont2(this VisualStyleRenderer rnd, IDeviceContext dc = null, Font defaultValue = null)
		{
			...
			{
				LOGFONT f;
				var hres = GetThemeFont(new SafeThemeHandle(rnd.Handle, false), hdc, rnd.Part, rnd.State, 210, out f);
				if (hres != 0)
					return defaultValue;
				return f.ToFont();
			}

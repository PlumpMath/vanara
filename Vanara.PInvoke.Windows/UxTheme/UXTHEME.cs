...
namespace Vanara.PInvoke
{
	public static partial class UxTheme
	{
		...
		public delegate int DrawThemeTextCallback(Gdi32.SafeDCHandle hdc, string text, int textLen, ref RECT rc, int flags, IntPtr lParam);
		...
		[DllImport(nameof(UxTheme), ExactSpelling = true)]
		[System.Security.SecurityCritical]
		public static extern int DrawThemeParentBackground(HandleRef hwnd, Gdi32.SafeDCHandle hdc, PRECT pRect);
		...
		[DllImport(nameof(UxTheme), ExactSpelling = true, EntryPoint = "GetThemeIntList")]

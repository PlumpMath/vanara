...
namespace Vanara.PInvoke
{
	public static partial class Shell32
	{
		...
		public enum BrowseForFolderMessages : uint
		{
			...
			BFFM_IUNKNOWN = 5,
			BFFM_SETSTATUSTEXTA = User32.WindowMessage.WM_USER + 100,
			BFFM_ENABLEOK = User32.WindowMessage.WM_USER + 101,
			BFFM_SETSELECTIONA = User32.WindowMessage.WM_USER + 102,
			BFFM_SETSELECTIONW = User32.WindowMessage.WM_USER + 103,
			BFFM_SETSTATUSTEXTW = User32.WindowMessage.WM_USER + 104,
			BFFM_SETOKTEXT = User32.WindowMessage.WM_USER + 105,
			BFFM_SETEXPANDED = User32.WindowMessage.WM_USER + 106
		}
		...
		public struct BROWSEINFO
		{
			...
			public BROWSEINFO(IntPtr hWnd, IntPtr rootPidl, string title, BrowseInfoFlag flags, BrowseCallbackProc callback, IntPtr displayNameBuffer)
			{
				hwndOwner = hWnd;
				pidlRoot = rootPidl;

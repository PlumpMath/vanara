...
namespace Vanara.PInvoke
{
	public static partial class Shell32
	{
		...
		public enum SHELL_LINK_DATA_FLAGS : uint
		{
			...
			/// <summary>
			/// Introduced in Windows Vista. Disable object ID distributed tracking information.
			/// </summary>
			SLDF_FORCE_NO_LINKTRACK = 0x00040000,
			/// <summary>
			/// Introduced in Windows Vista. Enable the caching of target metadata into the link file.
			/// </summary>
			SLDF_ENABLE_TARGET_METADATA = 0x000800000,
			/// <summary>
			/// Introduced in Windows 7. Disable shell link tracking.
			/// </summary>
			SLDF_DISABLE_LINK_PATH_TRACKING = 0x00100000,
			/// <summary>
			/// Introduced in Windows Vista. Disable known folder tracking information.
			/// </summary>
			SLDF_DISABLE_KNOWNFOLDER_RELATIVE_TRACKING = 0x00200000,
			/// <summary>
			/// Introduced in Windows 7. Disable known folder alias mapping when loading the IDList during deserialization.
			/// </summary>
			SLDF_NO_KF_ALIAS = 0x00400000,
			/// <summary>
			/// Introduced in Windows 7. Allow link to point to another shell link as long as this does not create cycles.
			/// </summary>
			SLDF_ALLOW_LINK_TO_LINK = 0x00800000,
			/// <summary>
			/// Introduced in Windows 7. Remove alias when saving the IDList.
			/// </summary>
		...
		/// <summary>
		/// Allows an application to retrieve the most recent and frequent documents opened in that app, as reported via
		/// SHAddToRecentDocs
		/// </summary>
		/// <securitynote>Critical: Suppresses unmanaged code security.</securitynote>
		[SuppressUnmanagedCodeSecurity]
		...
		public interface IEnumIDList
		{
			...
			/// </returns>
			[PreserveSig]
			HRESULT Next(uint celt, out PIDL rgelt, out int pceltFetched);
		...
		public interface IFileOpenDialog : IFileDialog
		{
			...
			new void SetOptions(FILEOPENDIALOGOPTIONS fileopendialogoptions);
		...
		public interface IFileSaveDialog : IFileDialog
		{
			...
			void ApplyProperties(IShellItem psi, [MarshalAs(UnmanagedType.Interface)] object pStore, [In] ref IntPtr hwnd,
				[MarshalAs(UnmanagedType.Interface)] object pSink);
		}
		...
		public interface IKnownFolder
		{
			...
			void GetIDList([In] KNOWN_FOLDER_FLAG dwFlags);
		...
		public enum KF_REDIRECT_FLAGS
		{
			...
			KF_REDIRECT_SET_OWNER_EXPLICIT = 0x00000008, // The owner of any newly created folder will be set explicitly by default if user belongs to Administrators group Administrators will be the owner
			...
			KF_REDIRECT_EXCLUDE_ALL_KNOWN_SUBFOLDERS = 0x00000800, // Exclude all known subfolders from redirection
		}
		...
		public interface IKnownFolderManager
		{
			...
			void Redirect([In, MarshalAs(UnmanagedType.LPStruct)] Guid rfid, [In] IntPtr hwnd, [In] KF_REDIRECT_FLAGS Flags,
		...
		public interface IPropertyStore
		{
			...
			void GetValue([In] ref ShellItemPropertyKey pkey, [Out] Ole32.PROPVARIANT pv);

			void SetValue([In] ref ShellItemPropertyKey pkey, [In] Ole32.PROPVARIANT pv);

			void Commit();
		}

		public enum GetInfoTipFlags
		{
		...
		{
			[return: MarshalAs(UnmanagedType.LPWStr)]
			string GetInfoTip(GetInfoTipFlags dwFlags);
		...
		public interface IShellFolder
		{
			...
			[return: MarshalAs(UnmanagedType.Interface)]
			object BindToStorage(PIDL pidl, IBindCtx pbc, [In, MarshalAs(UnmanagedType.LPStruct)] Guid riid);
			...
			// issues for you
			[PreserveSig]
			HRESULT CompareIDs(IntPtr lParam, PIDL pidl1, PIDL pidl2);
		...
		{
			/// <summary>Use this for IShellFolder::BindToObject() objects; IShellFolder</summary>
			public static readonly Guid BHID_SFObject = new Guid("{3981e224-f559-11d3-8e3a-00c04f6837d5}");

			/// <summary>Use this for IShellFolder::GetUIObject() objects; IContextMenu, IDataObject, IDropTarget, IQueryAssociation, etc.</summary>
			public static readonly Guid BHID_SFUIObject = new Guid("{3981e225-f559-11d3-8e3a-00c04f6837d5}");

			/// <summary>Use this for IShellFolder::CreateViewObject() objects; IShellView, IDropTarget, IContextMenu</summary>
			public static readonly Guid BHID_SFViewObject = new Guid("{3981e226-f559-11d3-8e3a-00c04f6837d5}");

			/// <summary>Use this for storage objects like IStream, IPropertyStore, IStorage</summary>
			public static readonly Guid BHID_Storage = new Guid("{3981e227-f559-11d3-8e3a-00c04f6837d5}");

			/// <summary>Use this to get an IStream for the item</summary>
			public static readonly Guid BHID_Stream = new Guid("{1CEBB3AB-7C10-499a-A417-92CA16C4CB83}");

			/// <summary>Use this to get an IRandomAccessStream for the item</summary>
			public static readonly Guid BHID_RandomAccessStream = new Guid("{f16fc93b-77ae-4cfe-bda7-a866eea6878d}");

			/// <summary>Use this to deref the item if it is a link to get its target item, use IShellItem</summary>
			public static readonly Guid BHID_LinkTargetItem = new Guid("{3981e228-f559-11d3-8e3a-00c04f6837d5}");

			/// <summary>If the item is a folder use this to get an IEnumShellItems that enumerates the storage contents</summary>
			public static readonly Guid BHID_StorageEnum = new Guid("{4621A4E3-F0D6-4773-8A9C-46E77B174840}");

			/// <summary>If the item is a folder use this to get an ITransferSource or ITransferDestiation object</summary>
			public static readonly Guid BHID_Transfer = new Guid("{5D080304-FE2C-48fc-84CE-CF620B0F3C53}");

			/// <summary>Use this to get an IPropertyStore or IPropertyStoreFactory to have more control over the property store for the item</summary>
			public static readonly Guid BHID_PropertyStore = new Guid("{0384e1a4-1523-439c-a4c8-ab911052f586}");

			/// <summary>Use this to get IExtractImage / IThumbnailProvider for an item</summary>
			public static readonly Guid BHID_ThumbnailHandler = new Guid("{7b2e650a-8e20-4f4a-b09e-6597afc72fb0}");

			/// <summary>If the item is a folder use this to get an IEnumShellItems that enumerates all items in the folder including folders, non folders and hidden items</summary>
			public static readonly Guid BHID_EnumItems = new Guid("{94f60519-2850-4924-aa5a-d15e84868039}");

			/// <summary>Use this to get an IDataObject for an item or an array of items IShellItem/IShellItemArray::BindToHandler()</summary>
			public static readonly Guid BHID_DataObject = new Guid("{B8C0BD9F-ED24-455c-83E6-D5390C4FE8C4}");

			/// <summary>Use this to get an IQueryAssociations for an item or an array of items IShellItem/IShellItemArray::BindToHandler()</summary>
			public static readonly Guid BHID_AssociationArray = new Guid("{bea9ef17-82f1-4f60-9284-4f8db75c3be9}");

			/// <summary>Use this to get an IFilter for an item</summary>
			public static readonly Guid BHID_Filter = new Guid("{38d08778-f557-4690-9ebf-ba54706ad8f7}");

			/// <summary>Use this to retrieve an IEnumAssocHandlers that enumerates the association handlers for the given item.  Returns an enumeration of recommended handlers, similar to calling SHAssocEnumHandlers with ASSOC_FILTER_RECOMMENDED.</summary>
			public static readonly Guid BHID_EnumAssocHandlers = new Guid("{b8ab0b9c-c2ec-4f7a-918d-314900e6280a}");

			/// <summary>Use this to retrieve an IFilePlaceholder that provides placeholder file functionality.</summary>
			public static readonly Guid BHID_FilePlaceholder = new Guid("{8677DCEB-AAE0-4005-8D3D-547FA852F825}");
		}
		...
		public interface IShellItem2 : IShellItem
		{
			...
			void GetProperty([In] ref ShellItemPropertyKey key, [Out] Ole32.PROPVARIANT pv);
		...
		public interface IShellItemArray
		{
			...
			[return: MarshalAs(UnmanagedType.Interface)]
			object GetPropertyStore(int flags, [In, MarshalAs(UnmanagedType.LPStruct)] Guid riid);

			[return: MarshalAs(UnmanagedType.Interface)]
			object GetPropertyDescriptionList([In] ref ShellItemPropertyKey keyType, [In, MarshalAs(UnmanagedType.LPStruct)] Guid riid);
		...
		public interface IShellLinkDataList
		{
			...
			void CopyDataBlock(ShellDataBlockSignature dwSig, ref IntPtr ppDataBlock);
		...
		public interface ITaskbarList4 : ITaskbarList3
		{
			...
			[PreserveSig]
			new HRESULT SetProgressState(IntPtr hwnd, TBPFLAG tbpFlags);
		...
		public struct EXP_DARWIN_LINK
		{
			...
			[MarshalAs(UnmanagedType.LPStr, SizeConst = Kernel32.MAX_PATH)]
			public string szDarwinID;
			[MarshalAs(UnmanagedType.LPWStr, SizeConst = Kernel32.MAX_PATH)]
		...
		public struct NT_CONSOLE_PROPS
		{
			...
			[MarshalAs(UnmanagedType.LPWStr, SizeConst = Gdi32.LF_FACESIZE)] public string FaceName;
		...
		public struct ShellItemPropertyKey : IComparable<ShellItemPropertyKey>
		{
			...
			public ShellItemPropertyKey(Guid key, uint id)
			{
				fmtid = key;
				pid = id;
			}
			...
			{
				if (obj is ShellItemPropertyKey)
					return Equals(Key, ((ShellItemPropertyKey)obj).Key) && Id == ((ShellItemPropertyKey)obj).Id;
				return false;
			}
			...
			public static implicit operator ShellItemPropertyKey(PROPERTYKEY pk) => new ShellItemPropertyKey(pk.fmtid, pk.pid);

			public static implicit operator PROPERTYKEY(ShellItemPropertyKey pk) => new PROPERTYKEY {fmtid = pk.fmtid, pid = pk.pid};
		}
		...
		{
			private static Dictionary<ShellItemPropertyKey, string> revIndex;
			...
			/// </summary>
			public static ShellItemPropertyKey AcquisitionID
				=> new ShellItemPropertyKey(new Guid("{65A98875-3C80-40AB-ABBC-EFDAF77DBEE2}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ApplicationName
				=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 18);
			...
			/// </summary>
			public static ShellItemPropertyKey Author
				=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 4);
			...
			///     </para>
			/// </summary>
			public static ShellItemPropertyKey Capacity
				=> new ShellItemPropertyKey(new Guid("{9B174B35-40FF-11D2-A27E-00C04FC30871}"), 3);
			...
			/// </summary>
			public static ShellItemPropertyKey Category
				=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 2);
			...
			/// </summary>
			public static ShellItemPropertyKey Comment
				=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 6);
			...
			/// </summary>
			public static ShellItemPropertyKey Company
				=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 15);
			...
			/// </summary>
			public static ShellItemPropertyKey ComputerName
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 5);
			...
			/// </summary>
			public static ShellItemPropertyKey ContainedItems
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 29);
			...
			/// </summary>
			public static ShellItemPropertyKey ContentStatus
				=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 27);
			...
			/// </summary>
			public static ShellItemPropertyKey ContentType
				=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 26);
			...
			/// </summary>
			public static ShellItemPropertyKey Copyright
				=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 11);
			...
			/// </summary>
			public static ShellItemPropertyKey DateAccessed
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 16);
			...
			/// </summary>
			public static ShellItemPropertyKey DateAcquired
				=> new ShellItemPropertyKey(new Guid("{2CBAA8F5-D81F-47CA-B17A-F8D822300131}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey DateArchived
				=> new ShellItemPropertyKey(new Guid("{43F8D7B7-A444-4F87-9383-52271C9B915C}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey DateCompleted
				=> new ShellItemPropertyKey(new Guid("{72FAB781-ACDA-43E5-B155-B2434F85E678}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey DateCreated
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 15);
			...
			/// </summary>
			public static ShellItemPropertyKey DateImported
				=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 18258);
			...
			/// </summary>
			public static ShellItemPropertyKey DateModified
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 14);
			...
			/// </summary>
			public static ShellItemPropertyKey DescriptionID
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 2);
			...
			/// </summary>
			public static ShellItemPropertyKey DueDate
				=> new ShellItemPropertyKey(new Guid("{3F8472B5-E0AF-4DB2-8071-C53FE76AE7CE}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey EndDate
				=> new ShellItemPropertyKey(new Guid("{C75FAA05-96FD-49E7-9CB4-9F601082D553}"), 100);
			...
			public static ShellItemPropertyKey FileAllocationSize
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 18);
			...
			/// </summary>
			public static ShellItemPropertyKey FileAttributes
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 13);
			...
			/// </summary>
			public static ShellItemPropertyKey FileCount
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 12);
			...
			/// </summary>
			public static ShellItemPropertyKey FileDescription
				=> new ShellItemPropertyKey(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 3);
			...
			/// </summary>
			public static ShellItemPropertyKey FileExtension
				=> new ShellItemPropertyKey(new Guid("{E4F10A3C-49E6-405D-8288-A23BD4EEAA6C}"), 100);
			...
			public static ShellItemPropertyKey FileFRN
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 21);
			...
			/// </summary>
			public static ShellItemPropertyKey FileName
				=> new ShellItemPropertyKey(new Guid("{41CF5AE0-F75A-4806-BD87-59C7D9248EB9}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey FileOwner
				=> new ShellItemPropertyKey(new Guid("{9B174B34-40FF-11D2-A27E-00C04FC30871}"), 4);
			...
			/// </summary>
			public static ShellItemPropertyKey FileVersion
				=> new ShellItemPropertyKey(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 4);
			...
			/// </summary>
			public static ShellItemPropertyKey FindData
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 0);
			...
			/// </summary>
			public static ShellItemPropertyKey FlagColor
				=> new ShellItemPropertyKey(new Guid("{67DF94DE-0CA7-4D6F-B792-053A3E4F03CF}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey FlagColorText
				=> new ShellItemPropertyKey(new Guid("{45EAE747-8E2A-40AE-8CBF-CA52ABA6152A}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey FlagStatus
				=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 12);
			...
			/// </summary>
			public static ShellItemPropertyKey FlagStatusText
				=> new ShellItemPropertyKey(new Guid("{DC54FD2E-189D-4871-AA01-08C2F57A4ABC}"), 100);
			...
			///     </para>
			/// </summary>
			public static ShellItemPropertyKey FreeSpace
				=> new ShellItemPropertyKey(new Guid("{9B174B35-40FF-11D2-A27E-00C04FC30871}"), 2);
			...
			/// </summary>
			public static ShellItemPropertyKey FullText
				=> new ShellItemPropertyKey(new Guid("{1E3EE840-BC2B-476C-8237-2ACD1A839B22}"), 6);
			...
			/// </summary>
			public static ShellItemPropertyKey IdentityProperty
				=> new ShellItemPropertyKey(new Guid("{A26F4AFC-7346-4299-BE47-EB1AE613139F}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ImageParsingName
				=> new ShellItemPropertyKey(new Guid("{D7750EE0-C6A4-48EC-B53E-B87B52E6D073}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey Importance
				=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 11);
			...
			/// </summary>
			public static ShellItemPropertyKey ImportanceText
				=> new ShellItemPropertyKey(new Guid("{A3B29791-7713-4E1D-BB40-17DB85F01831}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey InfoTipText
				=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 17);
			...
			/// </summary>
			public static ShellItemPropertyKey InternalName
				=> new ShellItemPropertyKey(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 5);
			...
			/// </summary>
			public static ShellItemPropertyKey IsAttachment
				=> new ShellItemPropertyKey(new Guid("{F23F425C-71A1-4FA8-922F-678EA4A60408}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey IsDefaultNonOwnerSaveLocation
				=> new ShellItemPropertyKey(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 5);
			...
			/// </summary>
			public static ShellItemPropertyKey IsDefaultSaveLocation
				=> new ShellItemPropertyKey(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 3);
			...
			/// </summary>
			public static ShellItemPropertyKey IsEncrypted
				=> new ShellItemPropertyKey(new Guid("{90E5E14E-648B-4826-B2AA-ACAF790E3513}"), 10);
			...
			/// </summary>
			public static ShellItemPropertyKey IsFlagged
				=> new ShellItemPropertyKey(new Guid("{5DA84765-E3FF-4278-86B0-A27967FBDD03}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey IsFlaggedComplete
				=> new ShellItemPropertyKey(new Guid("{A6F360D2-55F9-48DE-B909-620E090A647C}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey IsIncomplete
				=> new ShellItemPropertyKey(new Guid("{346C8BD1-2E6A-4C45-89A4-61B78E8E700F}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey IsLocationSupported
				=> new ShellItemPropertyKey(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 8);
			...
			/// </summary>
			public static ShellItemPropertyKey IsPinnedToNameSpaceTree
				=> new ShellItemPropertyKey(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 2);
			...
			/// </summary>
			public static ShellItemPropertyKey IsRead
				=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 10);
			...
			/// </summary>
			public static ShellItemPropertyKey IsSearchOnlyItem
				=> new ShellItemPropertyKey(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 4);
			...
			/// </summary>
			public static ShellItemPropertyKey IsSendToTarget
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 33);
			...
			/// </summary>
			public static ShellItemPropertyKey IsShared
				=> new ShellItemPropertyKey(new Guid("{EF884C5B-2BFE-41BB-AAE5-76EEDF4F9902}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemAuthors
				=> new ShellItemPropertyKey(new Guid("{D0A04F0A-462A-48A4-BB2F-3706E88DBD7D}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemClassType
				=> new ShellItemPropertyKey(new Guid("{048658AD-2DB8-41A4-BBB6-AC1EF1207EB1}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemDate
				=> new ShellItemPropertyKey(new Guid("{F7DB74B4-4287-4103-AFBA-F1B13DCD75CF}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemFolderNameDisplay
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 2);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemFolderPathDisplay
				=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 6);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemFolderPathDisplayNarrow
				=> new ShellItemPropertyKey(new Guid("{DABD30ED-0043-4789-A7F8-D013A4736622}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemName
				=> new ShellItemPropertyKey(new Guid("{6B8DA074-3B5C-43BC-886F-0A2CDCE00B6F}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemNameDisplay
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 10);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemNamePrefix
				=> new ShellItemPropertyKey(new Guid("{D7313FF1-A77A-401C-8C99-3DBDD68ADD36}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemParticipants
				=> new ShellItemPropertyKey(new Guid("{D4D0AA16-9948-41A4-AA85-D97FF9646993}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemPathDisplay
				=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 7);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemPathDisplayNarrow
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 8);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemType
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 11);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemTypeText
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 4);
			...
			/// </summary>
			public static ShellItemPropertyKey ItemUrl
				=> new ShellItemPropertyKey(new Guid("{49691C90-7E17-101A-A91C-08002B2ECDA9}"), 9);
			...
			/// </summary>
			public static ShellItemPropertyKey Keywords
				=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 5);
			...
			/// </summary>
			public static ShellItemPropertyKey Kind
				=> new ShellItemPropertyKey(new Guid("{1E3EE840-BC2B-476C-8237-2ACD1A839B22}"), 3);
			...
			/// </summary>
			public static ShellItemPropertyKey KindText
				=> new ShellItemPropertyKey(new Guid("{F04BEF95-C585-4197-A2B7-DF46FDC9EE6D}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey Language
				=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 28);
			...
			/// </summary>
			public static ShellItemPropertyKey MileageInformation
				=> new ShellItemPropertyKey(new Guid("{FDF84370-031A-4ADD-9E91-0D775F1C6605}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey MIMEType
				=> new ShellItemPropertyKey(new Guid("{0B63E350-9CCC-11D0-BCDB-00805FCCCE04}"), 5);
			...
			/// </summary>
			public static ShellItemPropertyKey NamespaceCLSID
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 6);
			...
			/// </summary>
			public static ShellItemPropertyKey Null
				=> new ShellItemPropertyKey(new Guid("{00000000-0000-0000-0000-000000000000}"), 0);
			...
			/// </summary>
			public static ShellItemPropertyKey OfflineAvailability
				=> new ShellItemPropertyKey(new Guid("{A94688B6-7D9F-4570-A648-E3DFC0AB2B3F}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey OfflineStatus
				=> new ShellItemPropertyKey(new Guid("{6D24888F-4718-4BDA-AFED-EA0FB4386CD8}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey OriginalFileName
				=> new ShellItemPropertyKey(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 6);
			...
			/// </summary>
			public static ShellItemPropertyKey OwnerSID
				=> new ShellItemPropertyKey(new Guid("{5D76B67F-9B3D-44BB-B6AE-25DA4F638A67}"), 6);
			...
			///     </para>
			/// </summary>
			public static ShellItemPropertyKey ParentalRating
				=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 21);
			...
			/// </summary>
			public static ShellItemPropertyKey ParentalRatingReason
				=> new ShellItemPropertyKey(new Guid("{10984E0A-F9F2-4321-B7EF-BAF195AF4319}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ParentalRatingsOrganization
				=> new ShellItemPropertyKey(new Guid("{A7FE0840-1344-46F0-8D37-52ED712A4BF9}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ParsingBindContext
				=> new ShellItemPropertyKey(new Guid("{DFB9A04D-362F-4CA3-B30B-0254B17B5B84}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ParsingName
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 24);
			...
			/// </summary>
			public static ShellItemPropertyKey ParsingPath
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 30);
			...
			/// </summary>
			public static ShellItemPropertyKey PerceivedType
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 9);
			...
			/// </summary>
			public static ShellItemPropertyKey PercentFull
				=> new ShellItemPropertyKey(new Guid("{9B174B35-40FF-11D2-A27E-00C04FC30871}"), 5);
			...
			/// </summary>
			public static ShellItemPropertyKey Priority
				=> new ShellItemPropertyKey(new Guid("{9C1FCF74-2D97-41BA-B4AE-CB2E3661A6E4}"), 5);
			...
			/// </summary>
			public static ShellItemPropertyKey PriorityText
				=> new ShellItemPropertyKey(new Guid("{D98BE98B-B86B-4095-BF52-9D23B2E0A752}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey Project
				=> new ShellItemPropertyKey(new Guid("{39A7F922-477C-48DE-8BC8-B28441E342E3}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ProviderItemID
				=> new ShellItemPropertyKey(new Guid("{F21D9941-81F0-471A-ADEE-4E74B49217ED}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey Rating
				=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 9);
			...
			/// </summary>
			public static ShellItemPropertyKey RatingText
				=> new ShellItemPropertyKey(new Guid("{90197CA7-FD8F-4E8C-9DA3-B57E1E609295}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey Sensitivity
				=> new ShellItemPropertyKey(new Guid("{F8D3F6AC-4874-42CB-BE59-AB454B30716A}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey SensitivityText
				=> new ShellItemPropertyKey(new Guid("{D0C7F054-3F72-4725-8527-129A577CB269}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey SFGAOFlags
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 25);
			...
			/// </summary>
			public static ShellItemPropertyKey SharedWith
				=> new ShellItemPropertyKey(new Guid("{EF884C5B-2BFE-41BB-AAE5-76EEDF4F9902}"), 200);
			...
			///     </para>
			/// </summary>
			public static ShellItemPropertyKey ShareUserRating
				=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 12);
			...
			/// </summary>
			public static ShellItemPropertyKey SharingStatus
				=> new ShellItemPropertyKey(new Guid("{EF884C5B-2BFE-41BB-AAE5-76EEDF4F9902}"), 300);
			...
			/// </summary>
			public static ShellItemPropertyKey SimpleRating
				=> new ShellItemPropertyKey(new Guid("{A09F084E-AD41-489F-8076-AA5BE3082BCA}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey Size
				=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 12);
			...
			/// </summary>
			public static ShellItemPropertyKey SoftwareUsed
				=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 305);
			...
			/// </summary>
			public static ShellItemPropertyKey SourceItem
				=> new ShellItemPropertyKey(new Guid("{668CDFA5-7A1B-4323-AE4B-E527393A1D81}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey StartDate
				=> new ShellItemPropertyKey(new Guid("{48FD6EC8-8A12-4CDF-A03E-4EC5A511EDDE}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey Status
				=> new ShellItemPropertyKey(new Guid("{000214A1-0000-0000-C000-000000000046}"), 9);
			...
			/// </summary>
			public static ShellItemPropertyKey Subject
				=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 3);
			...
			/// </summary>
			public static ShellItemPropertyKey Thumbnail
				=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 17);
			...
			/// </summary>
			public static ShellItemPropertyKey ThumbnailCacheId
				=> new ShellItemPropertyKey(new Guid("{446D16B1-8DAD-4870-A748-402EA43D788C}"), 100);
			...
			/// </summary>
			public static ShellItemPropertyKey ThumbnailStream
				=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 27);
			...
			/// </summary>
			public static ShellItemPropertyKey Title
				=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 2);
			...
			/// </summary>
			public static ShellItemPropertyKey TotalFileSize
				=> new ShellItemPropertyKey(new Guid("{28636AA6-953D-11D2-B5D6-00C04FD918D0}"), 14);
			...
			/// </summary>
			public static ShellItemPropertyKey Trademarks
				=> new ShellItemPropertyKey(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 9);

			public static string ReverseLookup(ShellItemPropertyKey key)
			{
				if (revIndex == null)
				{
			...
			private static void AddMembersToIndex(Type type, int level = 0)
			{
				foreach (var pi in type.GetProperties(BindingFlags.Public | BindingFlags.Static))
				{
					if (pi.PropertyType == typeof(ShellItemPropertyKey))
					{
						...
						try
						{
							revIndex.Add((ShellItemPropertyKey)pi.GetValue(null, null), name.ToString());
						}
						catch { }
					}
				}
			...
			public static class AppUserModel
			{
				...
				/// </summary>
				public static ShellItemPropertyKey ExcludeFromShowInNewInstall
					=> new ShellItemPropertyKey(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey ID
					=> new ShellItemPropertyKey(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey IsDestListSeparator
					=> new ShellItemPropertyKey(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey PreventPinning
					=> new ShellItemPropertyKey(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey RelaunchCommand
					=> new ShellItemPropertyKey(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey RelaunchDisplayNameResource
					=> new ShellItemPropertyKey(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey RelaunchIconResource
					=> new ShellItemPropertyKey(new Guid("{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}"), 3);
			}
			...
			public static class Audio
			{
				...
				/// </summary>
				public static ShellItemPropertyKey ChannelCount
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 7);
				...
				/// </summary>
				public static ShellItemPropertyKey Compression
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 10);
				...
				/// </summary>
				public static ShellItemPropertyKey EncodingBitrate
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey Format
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey IsVariableBitRate
					=> new ShellItemPropertyKey(new Guid("{E6822FEE-8C17-4D62-823C-8E9CFCBD1D5C}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PeakValue
					=> new ShellItemPropertyKey(new Guid("{2579E5D0-1116-4084-BD9A-9B4F7CB4DF5E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SampleRate
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey SampleSize
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey StreamName
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey StreamNumber
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 8);
			}
			...
			public static class Calendar
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Duration
					=> new ShellItemPropertyKey(new Guid("{293CA35A-09AA-4DD2-B180-1FE245728A52}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey IsOnline
					=> new ShellItemPropertyKey(new Guid("{BFEE9149-E3E2-49A7-A862-C05988145CEC}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey IsRecurring
					=> new ShellItemPropertyKey(new Guid("{315B9C8D-80A9-4EF9-AE16-8E746DA51D70}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Location
					=> new ShellItemPropertyKey(new Guid("{F6272D18-CECC-40B1-B26A-3911717AA7BD}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OptionalAttendeeAddresses
					=> new ShellItemPropertyKey(new Guid("{D55BAE5A-3892-417A-A649-C6AC5AAAEAB3}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OptionalAttendeeNames
					=> new ShellItemPropertyKey(new Guid("{09429607-582D-437F-84C3-DE93A2B24C3C}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OrganizerAddress
					=> new ShellItemPropertyKey(new Guid("{744C8242-4DF5-456C-AB9E-014EFB9021E3}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OrganizerName
					=> new ShellItemPropertyKey(new Guid("{AAA660F9-9865-458E-B484-01BC7FE3973E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ReminderTime
					=> new ShellItemPropertyKey(new Guid("{72FC5BA4-24F9-4011-9F3F-ADD27AFAD818}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey RequiredAttendeeAddresses
					=> new ShellItemPropertyKey(new Guid("{0BA7D6C3-568D-4159-AB91-781A91FB71E5}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey RequiredAttendeeNames
					=> new ShellItemPropertyKey(new Guid("{B33AF30B-F552-4584-936C-CB93E5CDA29F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Resources
					=> new ShellItemPropertyKey(new Guid("{00F58A38-C54B-4C40-8696-97235980EAE1}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ResponseStatus
					=> new ShellItemPropertyKey(new Guid("{188C1F91-3C40-4132-9EC5-D8B03B72A8A2}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ShowTimeAs
					=> new ShellItemPropertyKey(new Guid("{5BF396D4-5EB2-466F-BDE9-2FB3F2361D6E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ShowTimeAsText
					=> new ShellItemPropertyKey(new Guid("{53DA57CF-62C0-45C4-81DE-7610BCEFD7F5}"), 100);
			}
			...
			public static class Communication
			{
				...
				/// </summary>
				public static ShellItemPropertyKey AccountName
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey DateItemExpires
					=> new ShellItemPropertyKey(new Guid("{428040AC-A177-4C8A-9760-F6F761227F9A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FollowupIconIndex
					=> new ShellItemPropertyKey(new Guid("{83A6347E-6FE4-4F40-BA9C-C4865240D1F4}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HeaderItem
					=> new ShellItemPropertyKey(new Guid("{C9C34F84-2241-4401-B607-BD20ED75AE7F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PolicyTag
					=> new ShellItemPropertyKey(new Guid("{EC0B4191-AB0B-4C66-90B6-C6637CDEBBAB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SecurityFlags
					=> new ShellItemPropertyKey(new Guid("{8619A4B6-9F4D-4429-8C0F-B996CA59E335}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Suffix
					=> new ShellItemPropertyKey(new Guid("{807B653A-9E91-43EF-8F97-11CE04EE20C5}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TaskStatus
					=> new ShellItemPropertyKey(new Guid("{BE1A72C6-9A1D-46B7-AFE7-AFAF8CEF4999}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TaskStatusText
					=> new ShellItemPropertyKey(new Guid("{A6744477-C237-475B-A075-54F34498292A}"), 100);
			}
			...
			public static class Computer
			{
				...
				/// </summary>
				public static ShellItemPropertyKey DecoratedFreeSpace
					=> new ShellItemPropertyKey(new Guid("{9B174B35-40FF-11D2-A27E-00C04FC30871}"), 7);
			}
			...
			public static class Contact
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Anniversary
					=> new ShellItemPropertyKey(new Guid("{9AD5BADB-CEA7-4470-A03D-B84E51B9949E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey AssistantName
					=> new ShellItemPropertyKey(new Guid("{CD102C9C-5540-4A88-A6F6-64E4981C8CD1}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey AssistantTelephone
					=> new ShellItemPropertyKey(new Guid("{9A93244D-A7AD-4FF8-9B99-45EE4CC09AF6}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Birthday
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 47);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessAddress
					=> new ShellItemPropertyKey(new Guid("{730FB6DD-CF7C-426B-A03F-BD166CC9EE24}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessAddressCity
					=> new ShellItemPropertyKey(new Guid("{402B5934-EC5A-48C3-93E6-85E86A2D934E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessAddressCountry
					=> new ShellItemPropertyKey(new Guid("{B0B87314-FCF6-4FEB-8DFF-A50DA6AF561C}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessAddressPostalCode
					=> new ShellItemPropertyKey(new Guid("{E1D4A09E-D758-4CD1-B6EC-34A8B5A73F80}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessAddressPostOfficeBox
					=> new ShellItemPropertyKey(new Guid("{BC4E71CE-17F9-48D5-BEE9-021DF0EA5409}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessAddressState
					=> new ShellItemPropertyKey(new Guid("{446F787F-10C4-41CB-A6C4-4D0343551597}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessAddressStreet
					=> new ShellItemPropertyKey(new Guid("{DDD1460F-C0BF-4553-8CE4-10433C908FB0}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessFaxNumber
					=> new ShellItemPropertyKey(new Guid("{91EFF6F3-2E27-42CA-933E-7C999FBE310B}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessHomePage
					=> new ShellItemPropertyKey(new Guid("{56310920-2491-4919-99CE-EADB06FAFDB2}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BusinessTelephone
					=> new ShellItemPropertyKey(new Guid("{6A15E5A0-0A1E-4CD7-BB8C-D2F1B0C929BC}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey CallbackTelephone
					=> new ShellItemPropertyKey(new Guid("{BF53D1C3-49E0-4F7F-8567-5A821D8AC542}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey CarTelephone
					=> new ShellItemPropertyKey(new Guid("{8FDC6DEA-B929-412B-BA90-397A257465FE}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Children
					=> new ShellItemPropertyKey(new Guid("{D4729704-8EF1-43EF-9024-2BD381187FD5}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey CompanyMainTelephone
					=> new ShellItemPropertyKey(new Guid("{8589E481-6040-473D-B171-7FA89C2708ED}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Department
					=> new ShellItemPropertyKey(new Guid("{FC9F7306-FF8F-4D49-9FB6-3FFE5C0951EC}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey EmailAddress
					=> new ShellItemPropertyKey(new Guid("{F8FA7FA3-D12B-4785-8A4E-691A94F7A3E7}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey EmailAddress2
					=> new ShellItemPropertyKey(new Guid("{38965063-EDC8-4268-8491-B7723172CF29}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey EmailAddress3
					=> new ShellItemPropertyKey(new Guid("{644D37B4-E1B3-4BAD-B099-7E7C04966ACA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey EmailAddresses
					=> new ShellItemPropertyKey(new Guid("{84D8F337-981D-44B3-9615-C7596DBA17E3}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey EmailName
					=> new ShellItemPropertyKey(new Guid("{CC6F4F24-6083-4BD4-8754-674D0DE87AB8}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FileAsName
					=> new ShellItemPropertyKey(new Guid("{F1A24AA7-9CA7-40F6-89EC-97DEF9FFE8DB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FirstName
					=> new ShellItemPropertyKey(new Guid("{14977844-6B49-4AAD-A714-A4513BF60460}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FullName
					=> new ShellItemPropertyKey(new Guid("{635E9051-50A5-4BA2-B9DB-4ED056C77296}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Gender
					=> new ShellItemPropertyKey(new Guid("{3C8CEE58-D4F0-4CF9-B756-4E5D24447BCD}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey GenderValue
					=> new ShellItemPropertyKey(new Guid("{3C8CEE58-D4F0-4CF9-B756-4E5D24447BCD}"), 101);
				...
				/// </summary>
				public static ShellItemPropertyKey Hobbies
					=> new ShellItemPropertyKey(new Guid("{5DC2253F-5E11-4ADF-9CFE-910DD01E3E70}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeAddress
					=> new ShellItemPropertyKey(new Guid("{98F98354-617A-46B8-8560-5B1B64BF1F89}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeAddressCity
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 65);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeAddressCountry
					=> new ShellItemPropertyKey(new Guid("{08A65AA1-F4C9-43DD-9DDF-A33D8E7EAD85}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeAddressPostalCode
					=> new ShellItemPropertyKey(new Guid("{8AFCC170-8A46-4B53-9EEE-90BAE7151E62}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeAddressPostOfficeBox
					=> new ShellItemPropertyKey(new Guid("{7B9F6399-0A3F-4B12-89BD-4ADC51C918AF}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeAddressState
					=> new ShellItemPropertyKey(new Guid("{C89A23D0-7D6D-4EB8-87D4-776A82D493E5}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeAddressStreet
					=> new ShellItemPropertyKey(new Guid("{0ADEF160-DB3F-4308-9A21-06237B16FA2A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeFaxNumber
					=> new ShellItemPropertyKey(new Guid("{660E04D6-81AB-4977-A09F-82313113AB26}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HomeTelephone
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 20);
				...
				/// </summary>
				public static ShellItemPropertyKey IMAddress
					=> new ShellItemPropertyKey(new Guid("{D68DBD8A-3374-4B81-9972-3EC30682DB3D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Initials
					=> new ShellItemPropertyKey(new Guid("{F3D8F40D-50CB-44A2-9718-40CB9119495D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey JobTitle
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey Label
					=> new ShellItemPropertyKey(new Guid("{97B0AD89-DF49-49CC-834E-660974FD755B}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LastName
					=> new ShellItemPropertyKey(new Guid("{8F367200-C270-457C-B1D4-E07C5BCD90C7}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MailingAddress
					=> new ShellItemPropertyKey(new Guid("{C0AC206A-827E-4650-95AE-77E2BB74FCC9}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MiddleName
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 71);
				...
				/// </summary>
				public static ShellItemPropertyKey MobileTelephone
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 35);
				...
				/// </summary>
				public static ShellItemPropertyKey NickName
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 74);
				...
				/// </summary>
				public static ShellItemPropertyKey OfficeLocation
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 7);
				...
				/// </summary>
				public static ShellItemPropertyKey OtherAddress
					=> new ShellItemPropertyKey(new Guid("{508161FA-313B-43D5-83A1-C1ACCF68622C}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OtherAddressCity
					=> new ShellItemPropertyKey(new Guid("{6E682923-7F7B-4F0C-A337-CFCA296687BF}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OtherAddressCountry
					=> new ShellItemPropertyKey(new Guid("{8F167568-0AAE-4322-8ED9-6055B7B0E398}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OtherAddressPostalCode
					=> new ShellItemPropertyKey(new Guid("{95C656C1-2ABF-4148-9ED3-9EC602E3B7CD}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OtherAddressPostOfficeBox
					=> new ShellItemPropertyKey(new Guid("{8B26EA41-058F-43F6-AECC-4035681CE977}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OtherAddressState
					=> new ShellItemPropertyKey(new Guid("{71B377D6-E570-425F-A170-809FAE73E54E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OtherAddressStreet
					=> new ShellItemPropertyKey(new Guid("{FF962609-B7D6-4999-862D-95180D529AEA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PagerTelephone
					=> new ShellItemPropertyKey(new Guid("{D6304E01-F8F5-4F45-8B15-D024A6296789}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PersonalTitle
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 69);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryAddressCity
					=> new ShellItemPropertyKey(new Guid("{C8EA94F0-A9E3-4969-A94B-9C62A95324E0}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryAddressCountry
					=> new ShellItemPropertyKey(new Guid("{E53D799D-0F3F-466E-B2FF-74634A3CB7A4}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryAddressPostalCode
					=> new ShellItemPropertyKey(new Guid("{18BBD425-ECFD-46EF-B612-7B4A6034EDA0}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryAddressPostOfficeBox
					=> new ShellItemPropertyKey(new Guid("{DE5EF3C7-46E1-484E-9999-62C5308394C1}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryAddressState
					=> new ShellItemPropertyKey(new Guid("{F1176DFE-7138-4640-8B4C-AE375DC70A6D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryAddressStreet
					=> new ShellItemPropertyKey(new Guid("{63C25B20-96BE-488F-8788-C09C407AD812}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryEmailAddress
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 48);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryTelephone
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 25);
				...
				/// </summary>
				public static ShellItemPropertyKey Profession
					=> new ShellItemPropertyKey(new Guid("{7268AF55-1CE4-4F6E-A41F-B6E4EF10E4A9}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SpouseName
					=> new ShellItemPropertyKey(new Guid("{9D2408B6-3167-422B-82B0-F583B7A7CFE3}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Suffix
					=> new ShellItemPropertyKey(new Guid("{176DC63C-2688-4E89-8143-A347800F25E9}"), 73);
				...
				/// </summary>
				public static ShellItemPropertyKey TelexNumber
					=> new ShellItemPropertyKey(new Guid("{C554493C-C1F7-40C1-A76C-EF8C0614003E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TTYTDDTelephone
					=> new ShellItemPropertyKey(new Guid("{AAF16BAC-2B55-45E6-9F6D-415EB94910DF}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey WebPage
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 18);
				...
				public static class JA
				{
					...
					/// </summary>
					public static ShellItemPropertyKey CompanyNamePhonetic
						=> new ShellItemPropertyKey(new Guid("{897B3694-FE9E-43E6-8066-260F590C0100}"), 2);
					...
					/// </summary>
					public static ShellItemPropertyKey FirstNamePhonetic
						=> new ShellItemPropertyKey(new Guid("{897B3694-FE9E-43E6-8066-260F590C0100}"), 3);
					...
					/// </summary>
					public static ShellItemPropertyKey LastNamePhonetic
						=> new ShellItemPropertyKey(new Guid("{897B3694-FE9E-43E6-8066-260F590C0100}"), 4);
				}
			}
			...
			public static class Device
			{
				...
				/// </summary>
				public static ShellItemPropertyKey PrinterURL
					=> new ShellItemPropertyKey(new Guid("{0B48F35A-BE6E-4F17-B108-3C4073D1669A}"), 15);
			}
			...
			public static class DeviceInterface
			{
				...
				/// </summary>
				public static ShellItemPropertyKey PrinterDriverDirectory
					=> new ShellItemPropertyKey(new Guid("{847C66DE-B8D6-4AF9-ABC3-6F4F926BC039}"), 14);
				...
				/// </summary>
				public static ShellItemPropertyKey PrinterDriverName
					=> new ShellItemPropertyKey(new Guid("{AFC47170-14F5-498C-8F30-B0D19BE449C6}"), 11);
				...
				/// </summary>
				public static ShellItemPropertyKey PrinterName
					=> new ShellItemPropertyKey(new Guid("{0A7B84EF-0C27-463F-84EF-06C5070001BE}"), 10);
				...
				/// </summary>
				public static ShellItemPropertyKey PrinterPortName
					=> new ShellItemPropertyKey(new Guid("{EEC7B761-6F94-41B1-949F-C729720DD13C}"), 12);
			}
			...
			public static class Devices
			{
				...
				/// </summary>
				public static ShellItemPropertyKey BatteryLife
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 10);
				...
				/// </summary>
				public static ShellItemPropertyKey BatteryPlusCharging
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 22);
				...
				/// </summary>
				public static ShellItemPropertyKey BatteryPlusChargingText
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 23);
				...
				/// </summary>
				public static ShellItemPropertyKey Category
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 91);
				...
				/// </summary>
				public static ShellItemPropertyKey CategoryGroup
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 94);
				...
				/// </summary>
				public static ShellItemPropertyKey CategoryPlural
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 92);
				...
				/// </summary>
				public static ShellItemPropertyKey ChargingState
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 11);
				...
				/// </summary>
				public static ShellItemPropertyKey Connected
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 55);
				...
				/// </summary>
				public static ShellItemPropertyKey ContainerId
					=> new ShellItemPropertyKey(new Guid("{8C7ED206-3F8A-4827-B3AB-AE9E1FAEFC6C}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey DefaultTooltip
					=> new ShellItemPropertyKey(new Guid("{880F70A2-6082-47AC-8AAB-A739D1A300C3}"), 153);
				...
				/// </summary>
				public static ShellItemPropertyKey DeviceDescription1
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 81);
				...
				/// </summary>
				public static ShellItemPropertyKey DeviceDescription2
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 82);
				...
				/// </summary>
				public static ShellItemPropertyKey DiscoveryMethod
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 52);
				...
				/// </summary>
				public static ShellItemPropertyKey FriendlyName
					=> new ShellItemPropertyKey(new Guid("{656A3BB3-ECC0-43FD-8477-4AE0404A96CD}"), 12288);
				...
				/// </summary>
				public static ShellItemPropertyKey FunctionPaths
					=> new ShellItemPropertyKey(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey InterfacePaths
					=> new ShellItemPropertyKey(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey IsDefault
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 86);
				...
				/// </summary>
				public static ShellItemPropertyKey IsNetworkConnected
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 85);
				...
				/// </summary>
				public static ShellItemPropertyKey IsShared
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 84);
				...
				/// </summary>
				public static ShellItemPropertyKey IsSoftwareInstalling
					=> new ShellItemPropertyKey(new Guid("{83DA6326-97A6-4088-9453-A1923F573B29}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey LaunchDeviceStageFromExplorer
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 77);
				...
				/// </summary>
				public static ShellItemPropertyKey LocalMachine
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 70);
				...
				/// </summary>
				public static ShellItemPropertyKey Manufacturer
					=> new ShellItemPropertyKey(new Guid("{656A3BB3-ECC0-43FD-8477-4AE0404A96CD}"), 8192);
				...
				/// </summary>
				public static ShellItemPropertyKey MissedCalls
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey ModelName
					=> new ShellItemPropertyKey(new Guid("{656A3BB3-ECC0-43FD-8477-4AE0404A96CD}"), 8194);
				...
				/// </summary>
				public static ShellItemPropertyKey ModelNumber
					=> new ShellItemPropertyKey(new Guid("{656A3BB3-ECC0-43FD-8477-4AE0404A96CD}"), 8195);
				...
				/// </summary>
				public static ShellItemPropertyKey NetworkedTooltip
					=> new ShellItemPropertyKey(new Guid("{880F70A2-6082-47AC-8AAB-A739D1A300C3}"), 152);
				...
				/// </summary>
				public static ShellItemPropertyKey NetworkName
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 7);
				...
				/// </summary>
				public static ShellItemPropertyKey NetworkType
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey NewPictures
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey Notification
					=> new ShellItemPropertyKey(new Guid("{06704B0C-E830-4C81-9178-91E4E95A80A0}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey NotificationStore
					=> new ShellItemPropertyKey(new Guid("{06704B0C-E830-4C81-9178-91E4E95A80A0}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey NotWorkingProperly
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 83);
				...
				/// </summary>
				public static ShellItemPropertyKey Paired
					=> new ShellItemPropertyKey(new Guid("{78C34FC8-104A-4ACA-9EA4-524D52996E57}"), 56);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryCategory
					=> new ShellItemPropertyKey(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 10);
				...
				/// </summary>
				public static ShellItemPropertyKey Roaming
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey SafeRemovalRequired
					=> new ShellItemPropertyKey(new Guid("{AFD97640-86A3-4210-B67C-289C41AABE55}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey SharedTooltip
					=> new ShellItemPropertyKey(new Guid("{880F70A2-6082-47AC-8AAB-A739D1A300C3}"), 151);
				...
				/// </summary>
				public static ShellItemPropertyKey SignalStrength
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey Status1
					=> new ShellItemPropertyKey(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 257);
				...
				/// </summary>
				public static ShellItemPropertyKey Status2
					=> new ShellItemPropertyKey(new Guid("{D08DD4C0-3A9E-462E-8290-7B636B2576B9}"), 258);
				...
				/// </summary>
				public static ShellItemPropertyKey StorageCapacity
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 12);
				...
				/// </summary>
				public static ShellItemPropertyKey StorageFreeSpace
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 13);
				...
				/// </summary>
				public static ShellItemPropertyKey StorageFreeSpacePercent
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 14);
				...
				/// </summary>
				public static ShellItemPropertyKey TextMessages
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey Voicemail
					=> new ShellItemPropertyKey(new Guid("{49CD1F76-5626-4B17-A4E8-18B4AA1A2213}"), 6);
				...
				public static class Notifications
				{
					...
					/// </summary>
					public static ShellItemPropertyKey LowBattery
						=> new ShellItemPropertyKey(new Guid("{C4C07F2B-8524-4E66-AE3A-A6235F103BEB}"), 2);
					...
					/// </summary>
					public static ShellItemPropertyKey MissedCall
						=> new ShellItemPropertyKey(new Guid("{6614EF48-4EFE-4424-9EDA-C79F404EDF3E}"), 2);
					...
					/// </summary>
					public static ShellItemPropertyKey NewMessage
						=> new ShellItemPropertyKey(new Guid("{2BE9260A-2012-4742-A555-F41B638B7DCB}"), 2);
					...
					/// </summary>
					public static ShellItemPropertyKey NewVoicemail
						=> new ShellItemPropertyKey(new Guid("{59569556-0A08-4212-95B9-FAE2AD6413DB}"), 2);
					...
					/// </summary>
					public static ShellItemPropertyKey StorageFull
						=> new ShellItemPropertyKey(new Guid("{A0E00EE1-F0C7-4D41-B8E7-26A7BD8D38B0}"), 2);
					...
					/// </summary>
					public static ShellItemPropertyKey StorageFullLinkText
						=> new ShellItemPropertyKey(new Guid("{A0E00EE1-F0C7-4D41-B8E7-26A7BD8D38B0}"), 3);
				}
			}
			...
			public static class Document
			{
				...
				/// </summary>
				public static ShellItemPropertyKey ByteCount
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey CharacterCount
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 16);
				...
				/// </summary>
				public static ShellItemPropertyKey ClientID
					=> new ShellItemPropertyKey(new Guid("{276D7BB0-5B34-4FB0-AA4B-158ED12A1809}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Contributor
					=> new ShellItemPropertyKey(new Guid("{F334115E-DA1B-4509-9B3D-119504DC7ABB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DateCreated
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 12);
				...
				/// </summary>
				public static ShellItemPropertyKey DatePrinted
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 11);
				...
				/// </summary>
				public static ShellItemPropertyKey DateSaved
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 13);
				...
				/// </summary>
				public static ShellItemPropertyKey Division
					=> new ShellItemPropertyKey(new Guid("{1E005EE6-BF27-428B-B01C-79676ACD2870}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DocumentID
					=> new ShellItemPropertyKey(new Guid("{E08805C8-E395-40DF-80D2-54F0D6C43154}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey HiddenSlideCount
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey LastAuthor
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey LineCount
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey Manager
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 14);
				...
				/// </summary>
				public static ShellItemPropertyKey MultimediaClipCount
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 10);
				...
				/// </summary>
				public static ShellItemPropertyKey NoteCount
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey PageCount
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 14);
				...
				/// </summary>
				public static ShellItemPropertyKey ParagraphCount
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey PresentationFormat
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey RevisionNumber
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey Security
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 19);
				...
				/// </summary>
				public static ShellItemPropertyKey SlideCount
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 7);
				...
				/// </summary>
				public static ShellItemPropertyKey Template
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 7);
				...
				/// </summary>
				public static ShellItemPropertyKey TotalEditingTime
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 10);
				...
				/// </summary>
				public static ShellItemPropertyKey Version
					=> new ShellItemPropertyKey(new Guid("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}"), 29);
				...
				/// </summary>
				public static ShellItemPropertyKey WordCount
					=> new ShellItemPropertyKey(new Guid("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}"), 15);
			}
			...
			public static class DRM
			{
				...
				/// </summary>
				public static ShellItemPropertyKey DatePlayExpires
					=> new ShellItemPropertyKey(new Guid("{AEAC19E4-89AE-4508-B9B7-BB867ABEE2ED}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey DatePlayStarts
					=> new ShellItemPropertyKey(new Guid("{AEAC19E4-89AE-4508-B9B7-BB867ABEE2ED}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey Description
					=> new ShellItemPropertyKey(new Guid("{AEAC19E4-89AE-4508-B9B7-BB867ABEE2ED}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey IsProtected
					=> new ShellItemPropertyKey(new Guid("{AEAC19E4-89AE-4508-B9B7-BB867ABEE2ED}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey PlayCount
					=> new ShellItemPropertyKey(new Guid("{AEAC19E4-89AE-4508-B9B7-BB867ABEE2ED}"), 4);
			}
			...
			public static class GPS
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Altitude
					=> new ShellItemPropertyKey(new Guid("{827EDB4F-5B73-44A7-891D-FDFFABEA35CA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey AltitudeDenominator
					=> new ShellItemPropertyKey(new Guid("{78342DCB-E358-4145-AE9A-6BFE4E0F9F51}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey AltitudeNumerator
					=> new ShellItemPropertyKey(new Guid("{2DAD1EB7-816D-40D3-9EC3-C9773BE2AADE}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey AltitudeRef
					=> new ShellItemPropertyKey(new Guid("{46AC629D-75EA-4515-867F-6DC4321C5844}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey AreaInformation
					=> new ShellItemPropertyKey(new Guid("{972E333E-AC7E-49F1-8ADF-A70D07A9BCAB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Date
					=> new ShellItemPropertyKey(new Guid("{3602C812-0F3B-45F0-85AD-603468D69423}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestBearing
					=> new ShellItemPropertyKey(new Guid("{C66D4B3C-E888-47CC-B99F-9DCA3EE34DEA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestBearingDenominator
					=> new ShellItemPropertyKey(new Guid("{7ABCF4F8-7C3F-4988-AC91-8D2C2E97ECA5}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestBearingNumerator
					=> new ShellItemPropertyKey(new Guid("{BA3B1DA9-86EE-4B5D-A2A4-A271A429F0CF}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestBearingRef
					=> new ShellItemPropertyKey(new Guid("{9AB84393-2A0F-4B75-BB22-7279786977CB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestDistance
					=> new ShellItemPropertyKey(new Guid("{A93EAE04-6804-4F24-AC81-09B266452118}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestDistanceDenominator
					=> new ShellItemPropertyKey(new Guid("{9BC2C99B-AC71-4127-9D1C-2596D0D7DCB7}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestDistanceNumerator
					=> new ShellItemPropertyKey(new Guid("{2BDA47DA-08C6-4FE1-80BC-A72FC517C5D0}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestDistanceRef
					=> new ShellItemPropertyKey(new Guid("{ED4DF2D3-8695-450B-856F-F5C1C53ACB66}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestLatitude
					=> new ShellItemPropertyKey(new Guid("{9D1D7CC5-5C39-451C-86B3-928E2D18CC47}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestLatitudeDenominator
					=> new ShellItemPropertyKey(new Guid("{3A372292-7FCA-49A7-99D5-E47BB2D4E7AB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestLatitudeNumerator
					=> new ShellItemPropertyKey(new Guid("{ECF4B6F6-D5A6-433C-BB92-4076650FC890}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestLatitudeRef
					=> new ShellItemPropertyKey(new Guid("{CEA820B9-CE61-4885-A128-005D9087C192}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestLongitude
					=> new ShellItemPropertyKey(new Guid("{47A96261-CB4C-4807-8AD3-40B9D9DBC6BC}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestLongitudeDenominator
					=> new ShellItemPropertyKey(new Guid("{425D69E5-48AD-4900-8D80-6EB6B8D0AC86}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestLongitudeNumerator
					=> new ShellItemPropertyKey(new Guid("{A3250282-FB6D-48D5-9A89-DBCACE75CCCF}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DestLongitudeRef
					=> new ShellItemPropertyKey(new Guid("{182C1EA6-7C1C-4083-AB4B-AC6C9F4ED128}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Differential
					=> new ShellItemPropertyKey(new Guid("{AAF4EE25-BD3B-4DD7-BFC4-47F77BB00F6D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DOP
					=> new ShellItemPropertyKey(new Guid("{0CF8FB02-1837-42F1-A697-A7017AA289B9}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DOPDenominator
					=> new ShellItemPropertyKey(new Guid("{A0BE94C5-50BA-487B-BD35-0654BE8881ED}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DOPNumerator
					=> new ShellItemPropertyKey(new Guid("{47166B16-364F-4AA0-9F31-E2AB3DF449C3}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ImgDirection
					=> new ShellItemPropertyKey(new Guid("{16473C91-D017-4ED9-BA4D-B6BAA55DBCF8}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ImgDirectionDenominator
					=> new ShellItemPropertyKey(new Guid("{10B24595-41A2-4E20-93C2-5761C1395F32}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ImgDirectionNumerator
					=> new ShellItemPropertyKey(new Guid("{DC5877C7-225F-45F7-BAC7-E81334B6130A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ImgDirectionRef
					=> new ShellItemPropertyKey(new Guid("{A4AAA5B7-1AD0-445F-811A-0F8F6E67F6B5}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Latitude
					=> new ShellItemPropertyKey(new Guid("{8727CFFF-4868-4EC6-AD5B-81B98521D1AB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LatitudeDenominator
					=> new ShellItemPropertyKey(new Guid("{16E634EE-2BFF-497B-BD8A-4341AD39EEB9}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LatitudeNumerator
					=> new ShellItemPropertyKey(new Guid("{7DDAAAD1-CCC8-41AE-B750-B2CB8031AEA2}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LatitudeRef
					=> new ShellItemPropertyKey(new Guid("{029C0252-5B86-46C7-ACA0-2769FFC8E3D4}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Longitude
					=> new ShellItemPropertyKey(new Guid("{C4C4DBB2-B593-466B-BBDA-D03D27D5E43A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LongitudeDenominator
					=> new ShellItemPropertyKey(new Guid("{BE6E176C-4534-4D2C-ACE5-31DEDAC1606B}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LongitudeNumerator
					=> new ShellItemPropertyKey(new Guid("{02B0F689-A914-4E45-821D-1DDA452ED2C4}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LongitudeRef
					=> new ShellItemPropertyKey(new Guid("{33DCF22B-28D5-464C-8035-1EE9EFD25278}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MapDatum
					=> new ShellItemPropertyKey(new Guid("{2CA2DAE6-EDDC-407D-BEF1-773942ABFA95}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MeasureMode
					=> new ShellItemPropertyKey(new Guid("{A015ED5D-AAEA-4D58-8A86-3C586920EA0B}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ProcessingMethod
					=> new ShellItemPropertyKey(new Guid("{59D49E61-840F-4AA9-A939-E2099B7F6399}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Satellites
					=> new ShellItemPropertyKey(new Guid("{467EE575-1F25-4557-AD4E-B8B58B0D9C15}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Speed
					=> new ShellItemPropertyKey(new Guid("{DA5D0862-6E76-4E1B-BABD-70021BD25494}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SpeedDenominator
					=> new ShellItemPropertyKey(new Guid("{7D122D5A-AE5E-4335-8841-D71E7CE72F53}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SpeedNumerator
					=> new ShellItemPropertyKey(new Guid("{ACC9CE3D-C213-4942-8B48-6D0820F21C6D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SpeedRef
					=> new ShellItemPropertyKey(new Guid("{ECF7F4C9-544F-4D6D-9D98-8AD79ADAF453}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Status
					=> new ShellItemPropertyKey(new Guid("{125491F4-818F-46B2-91B5-D537753617B2}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Track
					=> new ShellItemPropertyKey(new Guid("{76C09943-7C33-49E3-9E7E-CDBA872CFADA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TrackDenominator
					=> new ShellItemPropertyKey(new Guid("{C8D1920C-01F6-40C0-AC86-2F3A4AD00770}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TrackNumerator
					=> new ShellItemPropertyKey(new Guid("{702926F4-44A6-43E1-AE71-45627116893B}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TrackRef
					=> new ShellItemPropertyKey(new Guid("{35DBE6FE-44C3-4400-AAAE-D2C799C407E8}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey VersionID
					=> new ShellItemPropertyKey(new Guid("{22704DA4-C6B2-4A99-8E56-F16DF8C92599}"), 100);
			}
			...
			public static class Identity
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Blob
					=> new ShellItemPropertyKey(new Guid("{8C3B93A4-BAED-1A83-9A32-102EE313F6EB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DisplayName
					=> new ShellItemPropertyKey(new Guid("{7D683FC9-D155-45A8-BB1F-89D19BCB792F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey IsMeIdentity
					=> new ShellItemPropertyKey(new Guid("{A4108708-09DF-4377-9DFC-6D99986D5A67}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PrimaryEmailAddress
					=> new ShellItemPropertyKey(new Guid("{FCC16823-BAED-4F24-9B32-A0982117F7FA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ProviderID
					=> new ShellItemPropertyKey(new Guid("{74A7DE49-FA11-4D3D-A006-DB7E08675916}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey UniqueID
					=> new ShellItemPropertyKey(new Guid("{E55FC3B0-2B60-4220-918E-B21E8BF16016}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey UserName
					=> new ShellItemPropertyKey(new Guid("{C4322503-78CA-49C6-9ACC-A68E2AFD7B6B}"), 100);
			}
			...
			public static class IdentityProvider
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Name
					=> new ShellItemPropertyKey(new Guid("{B96EFF7B-35CA-4A35-8607-29E3A54C46EA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Picture
					=> new ShellItemPropertyKey(new Guid("{2425166F-5642-4864-992F-98FD98F294C3}"), 100);
			}
			...
			public static class Image
			{
				...
				/// </summary>
				public static ShellItemPropertyKey BitDepth
					=> new ShellItemPropertyKey(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 7);
				...
				/// </summary>
				public static ShellItemPropertyKey ColorSpace
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 40961);
				...
				/// </summary>
				public static ShellItemPropertyKey CompressedBitsPerPixel
					=> new ShellItemPropertyKey(new Guid("{364B6FA9-37AB-482A-BE2B-AE02F60D4318}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey CompressedBitsPerPixelDenominator
					=> new ShellItemPropertyKey(new Guid("{1F8844E1-24AD-4508-9DFD-5326A415CE02}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey CompressedBitsPerPixelNumerator
					=> new ShellItemPropertyKey(new Guid("{D21A7148-D32C-4624-8900-277210F79C0F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Compression
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 259);
				...
				/// </summary>
				public static ShellItemPropertyKey CompressionText
					=> new ShellItemPropertyKey(new Guid("{3F08E66F-2F44-4BB9-A682-AC35D2562322}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Dimensions
					=> new ShellItemPropertyKey(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 13);
				...
				/// </summary>
				public static ShellItemPropertyKey HorizontalResolution
					=> new ShellItemPropertyKey(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey HorizontalSize
					=> new ShellItemPropertyKey(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey ImageID
					=> new ShellItemPropertyKey(new Guid("{10DABE05-32AA-4C29-BF1A-63E2D220587F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ResolutionUnit
					=> new ShellItemPropertyKey(new Guid("{19B51FA6-1F92-4A5C-AB48-7DF0ABD67444}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey VerticalResolution
					=> new ShellItemPropertyKey(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey VerticalSize
					=> new ShellItemPropertyKey(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 4);
			}
			...
			public static class Journal
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Contacts
					=> new ShellItemPropertyKey(new Guid("{DEA7C82C-1D89-4A66-9427-A4E3DEBABCB1}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey EntryType
					=> new ShellItemPropertyKey(new Guid("{95BEB1FC-326D-4644-B396-CD3ED90E6DDF}"), 100);
			}
			...
			public static class LayoutPattern
			{
				...
				/// </summary>
				public static ShellItemPropertyKey ContentViewModeForBrowse
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 500);
				...
				/// </summary>
				public static ShellItemPropertyKey ContentViewModeForSearch
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 501);
			}
			...
			public static class Link
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Arguments
					=> new ShellItemPropertyKey(new Guid("{436F2667-14E2-4FEB-B30A-146C53B5B674}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Comment
					=> new ShellItemPropertyKey(new Guid("{B9B4B3FC-2B51-4A42-B5D8-324146AFCF25}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey DateVisited
					=> new ShellItemPropertyKey(new Guid("{5CBF2787-48CF-4208-B90E-EE5E5D420294}"), 23);
				...
				/// </summary>
				public static ShellItemPropertyKey Description
					=> new ShellItemPropertyKey(new Guid("{5CBF2787-48CF-4208-B90E-EE5E5D420294}"), 21);
				...
				/// </summary>
				public static ShellItemPropertyKey Status
					=> new ShellItemPropertyKey(new Guid("{B9B4B3FC-2B51-4A42-B5D8-324146AFCF25}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey TargetExtension
					=> new ShellItemPropertyKey(new Guid("{7A7D76F4-B630-4BD7-95FF-37CC51A975C9}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey TargetParsingPath
					=> new ShellItemPropertyKey(new Guid("{B9B4B3FC-2B51-4A42-B5D8-324146AFCF25}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey TargetSFGAOFlags
					=> new ShellItemPropertyKey(new Guid("{B9B4B3FC-2B51-4A42-B5D8-324146AFCF25}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey TargetSFGAOFlagsStrings
					=> new ShellItemPropertyKey(new Guid("{D6942081-D53B-443D-AD47-5E059D9CD27A}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey TargetUrl
					=> new ShellItemPropertyKey(new Guid("{5CBF2787-48CF-4208-B90E-EE5E5D420294}"), 2);
			}
			...
			public static class Media
			{
				...
				/// </summary>
				public static ShellItemPropertyKey AuthorUrl
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 32);
				...
				/// </summary>
				public static ShellItemPropertyKey AverageLevel
					=> new ShellItemPropertyKey(new Guid("{09EDD5B6-B301-43C5-9990-D00302EFFD46}"), 100);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey ClassPrimaryID
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 13);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey ClassSecondaryID
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 14);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey CollectionGroupID
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 24);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey CollectionID
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 25);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey ContentDistributor
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 18);
				...
				/// </summary>
				public static ShellItemPropertyKey ContentID
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 26);
				...
				/// </summary>
				public static ShellItemPropertyKey CreatorApplication
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 27);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey CreatorApplicationVersion
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 28);
				...
				/// </summary>
				public static ShellItemPropertyKey DateEncoded
					=> new ShellItemPropertyKey(new Guid("{2E4B640D-5019-46D8-8881-55414CC5CAA0}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DateReleased
					=> new ShellItemPropertyKey(new Guid("{DE41CC29-6971-4290-B472-F59F2E2F31E2}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Duration
					=> new ShellItemPropertyKey(new Guid("{64440490-4C8B-11D1-8B70-080036B11A03}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey DVDID
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 15);
				...
				/// </summary>
				public static ShellItemPropertyKey EncodedBy
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 36);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey EncodingSettings
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 37);
				...
				/// </summary>
				public static ShellItemPropertyKey FrameCount
					=> new ShellItemPropertyKey(new Guid("{6444048F-4C8B-11D1-8B70-080036B11A03}"), 12);
				...
				/// </summary>
				public static ShellItemPropertyKey MCDI
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 16);
				...
				/// </summary>
				public static ShellItemPropertyKey MetadataContentProvider
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 17);
				...
				/// </summary>
				public static ShellItemPropertyKey Producer
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 22);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey PromotionUrl
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 33);
				...
				/// </summary>
				public static ShellItemPropertyKey ProtectionType
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 38);
				...
				/// </summary>
				public static ShellItemPropertyKey ProviderRating
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 39);
				...
				/// </summary>
				public static ShellItemPropertyKey ProviderStyle
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 40);
				...
				/// </summary>
				public static ShellItemPropertyKey Publisher
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 30);
				...
				/// </summary>
				public static ShellItemPropertyKey SubscriptionContentId
					=> new ShellItemPropertyKey(new Guid("{9AEBAE7A-9644-487D-A92C-657585ED751A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SubTitle
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 38);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey UniqueFileIdentifier
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 35);
				...
				/// </summary>
				public static ShellItemPropertyKey UserNoAutoInfo
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 41);
				...
				///     </para>
				/// </summary>
				public static ShellItemPropertyKey UserWebUrl
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 34);
				...
				/// </summary>
				public static ShellItemPropertyKey Writer
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 23);
				...
				/// </summary>
				public static ShellItemPropertyKey Year
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 5);
			}
			...
			public static class Message
			{
				...
				/// </summary>
				public static ShellItemPropertyKey AttachmentContents
					=> new ShellItemPropertyKey(new Guid("{3143BF7C-80A8-4854-8880-E2E40189BDD0}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey AttachmentNames
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 21);
				...
				/// </summary>
				public static ShellItemPropertyKey BccAddress
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey BccName
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey CcAddress
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey CcName
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey ConversationID
					=> new ShellItemPropertyKey(new Guid("{DC8F80BD-AF1E-4289-85B6-3DFC1B493992}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ConversationIndex
					=> new ShellItemPropertyKey(new Guid("{DC8F80BD-AF1E-4289-85B6-3DFC1B493992}"), 101);
				...
				/// </summary>
				public static ShellItemPropertyKey DateReceived
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 20);
				...
				/// </summary>
				public static ShellItemPropertyKey DateSent
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 19);
				...
				/// </summary>
				public static ShellItemPropertyKey Flags
					=> new ShellItemPropertyKey(new Guid("{A82D9EE7-CA67-4312-965E-226BCEA85023}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FromAddress
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 13);
				...
				/// </summary>
				public static ShellItemPropertyKey FromName
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 14);
				...
				/// </summary>
				public static ShellItemPropertyKey HasAttachments
					=> new ShellItemPropertyKey(new Guid("{9C1FCF74-2D97-41BA-B4AE-CB2E3661A6E4}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey IsFwdOrReply
					=> new ShellItemPropertyKey(new Guid("{9A9BC088-4F6D-469E-9919-E705412040F9}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MessageClass
					=> new ShellItemPropertyKey(new Guid("{CD9ED458-08CE-418F-A70E-F912C7BB9C5C}"), 103);
				...
				/// </summary>
				public static ShellItemPropertyKey ProofInProgress
					=> new ShellItemPropertyKey(new Guid("{9098F33C-9A7D-48A8-8DE5-2E1227A64E91}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SenderAddress
					=> new ShellItemPropertyKey(new Guid("{0BE1C8E7-1981-4676-AE14-FDD78F05A6E7}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SenderName
					=> new ShellItemPropertyKey(new Guid("{0DA41CFA-D224-4A18-AE2F-596158DB4B3A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Store
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 15);
				...
				/// </summary>
				public static ShellItemPropertyKey ToAddress
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 16);
				...
				/// </summary>
				public static ShellItemPropertyKey ToDoFlags
					=> new ShellItemPropertyKey(new Guid("{1F856A9F-6900-4ABA-9505-2D5F1B4D66CB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ToDoTitle
					=> new ShellItemPropertyKey(new Guid("{BCCC8A3C-8CEF-42E5-9B1C-C69079398BC7}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ToName
					=> new ShellItemPropertyKey(new Guid("{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}"), 17);
			}
			...
			public static class Music
			{
				...
				/// </summary>
				public static ShellItemPropertyKey AlbumArtist
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 13);
				...
				/// </summary>
				public static ShellItemPropertyKey AlbumID
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey AlbumTitle
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey Artist
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey BeatsPerMinute
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 35);
				...
				/// </summary>
				public static ShellItemPropertyKey Composer
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 19);
				...
				/// </summary>
				public static ShellItemPropertyKey Conductor
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 36);
				...
				/// </summary>
				public static ShellItemPropertyKey ContentGroupDescription
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 33);
				...
				/// </summary>
				public static ShellItemPropertyKey DisplayArtist
					=> new ShellItemPropertyKey(new Guid("{FD122953-FA93-4EF7-92C3-04C946B2F7C8}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Genre
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 11);
				...
				/// </summary>
				public static ShellItemPropertyKey InitialKey
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 34);
				...
				/// </summary>
				public static ShellItemPropertyKey IsCompilation
					=> new ShellItemPropertyKey(new Guid("{C449D5CB-9EA4-4809-82E8-AF9D59DED6D1}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Lyrics
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 12);
				...
				/// </summary>
				public static ShellItemPropertyKey Mood
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 39);
				...
				/// </summary>
				public static ShellItemPropertyKey PartOfSet
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 37);
				...
				/// </summary>
				public static ShellItemPropertyKey Period
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 31);
				...
				/// </summary>
				public static ShellItemPropertyKey SynchronizedLyrics
					=> new ShellItemPropertyKey(new Guid("{6B223B6A-162E-4AA9-B39F-05D678FC6D77}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TrackNumber
					=> new ShellItemPropertyKey(new Guid("{56A3372E-CE9C-11D2-9F0E-006097C686F6}"), 7);
			}
			...
			public static class Note
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Color
					=> new ShellItemPropertyKey(new Guid("{4776CAFA-BCE4-4CB1-A23E-265E76D8EB11}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ColorText
					=> new ShellItemPropertyKey(new Guid("{46B4E8DE-CDB2-440D-885C-1658EB65B914}"), 100);
			}
			...
			public static class Photo
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Aperture
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 37378);
				...
				/// </summary>
				public static ShellItemPropertyKey ApertureDenominator
					=> new ShellItemPropertyKey(new Guid("{E1A9A38B-6685-46BD-875E-570DC7AD7320}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ApertureNumerator
					=> new ShellItemPropertyKey(new Guid("{0337ECEC-39FB-4581-A0BD-4C4CC51E9914}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Brightness
					=> new ShellItemPropertyKey(new Guid("{1A701BF6-478C-4361-83AB-3701BB053C58}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BrightnessDenominator
					=> new ShellItemPropertyKey(new Guid("{6EBE6946-2321-440A-90F0-C043EFD32476}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey BrightnessNumerator
					=> new ShellItemPropertyKey(new Guid("{9E7D118F-B314-45A0-8CFB-D654B917C9E9}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey CameraManufacturer
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 271);
				...
				/// </summary>
				public static ShellItemPropertyKey CameraModel
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 272);
				...
				/// </summary>
				public static ShellItemPropertyKey CameraSerialNumber
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 273);
				...
				/// </summary>
				public static ShellItemPropertyKey Contrast
					=> new ShellItemPropertyKey(new Guid("{2A785BA9-8D23-4DED-82E6-60A350C86A10}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ContrastText
					=> new ShellItemPropertyKey(new Guid("{59DDE9F2-5253-40EA-9A8B-479E96C6249A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DateTaken
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 36867);
				...
				/// </summary>
				public static ShellItemPropertyKey DigitalZoom
					=> new ShellItemPropertyKey(new Guid("{F85BF840-A925-4BC2-B0C4-8E36B598679E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DigitalZoomDenominator
					=> new ShellItemPropertyKey(new Guid("{745BAF0E-E5C1-4CFB-8A1B-D031A0A52393}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey DigitalZoomNumerator
					=> new ShellItemPropertyKey(new Guid("{16CBB924-6500-473B-A5BE-F1599BCBE413}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Event
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 18248);
				...
				/// </summary>
				public static ShellItemPropertyKey EXIFVersion
					=> new ShellItemPropertyKey(new Guid("{D35F743A-EB2E-47F2-A286-844132CB1427}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureBias
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 37380);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureBiasDenominator
					=> new ShellItemPropertyKey(new Guid("{AB205E50-04B7-461C-A18C-2F233836E627}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureBiasNumerator
					=> new ShellItemPropertyKey(new Guid("{738BF284-1D87-420B-92CF-5834BF6EF9ED}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureIndex
					=> new ShellItemPropertyKey(new Guid("{967B5AF8-995A-46ED-9E11-35B3C5B9782D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureIndexDenominator
					=> new ShellItemPropertyKey(new Guid("{93112F89-C28B-492F-8A9D-4BE2062CEE8A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureIndexNumerator
					=> new ShellItemPropertyKey(new Guid("{CDEDCF30-8919-44DF-8F4C-4EB2FFDB8D89}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureProgram
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 34850);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureProgramText
					=> new ShellItemPropertyKey(new Guid("{FEC690B7-5F30-4646-AE47-4CAAFBA884A3}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureTime
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 33434);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureTimeDenominator
					=> new ShellItemPropertyKey(new Guid("{55E98597-AD16-42E0-B624-21599A199838}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ExposureTimeNumerator
					=> new ShellItemPropertyKey(new Guid("{257E44E2-9031-4323-AC38-85C552871B2E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Flash
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 37385);
				...
				/// </summary>
				public static ShellItemPropertyKey FlashEnergy
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 41483);
				...
				/// </summary>
				public static ShellItemPropertyKey FlashEnergyDenominator
					=> new ShellItemPropertyKey(new Guid("{D7B61C70-6323-49CD-A5FC-C84277162C97}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FlashEnergyNumerator
					=> new ShellItemPropertyKey(new Guid("{FCAD3D3D-0858-400F-AAA3-2F66CCE2A6BC}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FlashManufacturer
					=> new ShellItemPropertyKey(new Guid("{AABAF6C9-E0C5-4719-8585-57B103E584FE}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FlashModel
					=> new ShellItemPropertyKey(new Guid("{FE83BB35-4D1A-42E2-916B-06F3E1AF719E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FlashText
					=> new ShellItemPropertyKey(new Guid("{6B8B68F6-200B-47EA-8D25-D8050F57339F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FNumber
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 33437);
				...
				/// </summary>
				public static ShellItemPropertyKey FNumberDenominator
					=> new ShellItemPropertyKey(new Guid("{E92A2496-223B-4463-A4E3-30EABBA79D80}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FNumberNumerator
					=> new ShellItemPropertyKey(new Guid("{1B97738A-FDFC-462F-9D93-1957E08BE90C}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalLength
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 37386);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalLengthDenominator
					=> new ShellItemPropertyKey(new Guid("{305BC615-DCA1-44A5-9FD4-10C0BA79412E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalLengthInFilm
					=> new ShellItemPropertyKey(new Guid("{A0E74609-B84D-4F49-B860-462BD9971F98}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalLengthNumerator
					=> new ShellItemPropertyKey(new Guid("{776B6B3B-1E3D-4B0C-9A0E-8FBAF2A8492A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalPlaneXResolution
					=> new ShellItemPropertyKey(new Guid("{CFC08D97-C6F7-4484-89DD-EBEF4356FE76}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalPlaneXResolutionDenominator
					=> new ShellItemPropertyKey(new Guid("{0933F3F5-4786-4F46-A8E8-D64DD37FA521}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalPlaneXResolutionNumerator
					=> new ShellItemPropertyKey(new Guid("{DCCB10AF-B4E2-4B88-95F9-031B4D5AB490}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalPlaneYResolution
					=> new ShellItemPropertyKey(new Guid("{4FFFE4D0-914F-4AC4-8D6F-C9C61DE169B1}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalPlaneYResolutionDenominator
					=> new ShellItemPropertyKey(new Guid("{1D6179A6-A876-4031-B013-3347B2B64DC8}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FocalPlaneYResolutionNumerator
					=> new ShellItemPropertyKey(new Guid("{A2E541C5-4440-4BA8-867E-75CFC06828CD}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey GainControl
					=> new ShellItemPropertyKey(new Guid("{FA304789-00C7-4D80-904A-1E4DCC7265AA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey GainControlDenominator
					=> new ShellItemPropertyKey(new Guid("{42864DFD-9DA4-4F77-BDED-4AAD7B256735}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey GainControlNumerator
					=> new ShellItemPropertyKey(new Guid("{8E8ECF7C-B7B8-4EB8-A63F-0EE715C96F9E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey GainControlText
					=> new ShellItemPropertyKey(new Guid("{C06238B2-0BF9-4279-A723-25856715CB9D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ISOSpeed
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 34855);
				...
				/// </summary>
				public static ShellItemPropertyKey LensManufacturer
					=> new ShellItemPropertyKey(new Guid("{E6DDCAF7-29C5-4F0A-9A68-D19412EC7090}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LensModel
					=> new ShellItemPropertyKey(new Guid("{E1277516-2B5F-4869-89B1-2E585BD38B7A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey LightSource
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 37384);
				...
				/// </summary>
				public static ShellItemPropertyKey MakerNote
					=> new ShellItemPropertyKey(new Guid("{FA303353-B659-4052-85E9-BCAC79549B84}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MakerNoteOffset
					=> new ShellItemPropertyKey(new Guid("{813F4124-34E6-4D17-AB3E-6B1F3C2247A1}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MaxAperture
					=> new ShellItemPropertyKey(new Guid("{08F6D7C2-E3F2-44FC-AF1E-5AA5C81A2D3E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MaxApertureDenominator
					=> new ShellItemPropertyKey(new Guid("{C77724D4-601F-46C5-9B89-C53F93BCEB77}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MaxApertureNumerator
					=> new ShellItemPropertyKey(new Guid("{C107E191-A459-44C5-9AE6-B952AD4B906D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MeteringMode
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 37383);
				...
				/// </summary>
				public static ShellItemPropertyKey MeteringModeText
					=> new ShellItemPropertyKey(new Guid("{F628FD8C-7BA8-465A-A65B-C5AA79263A9E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Orientation
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 274);
				...
				/// </summary>
				public static ShellItemPropertyKey OrientationText
					=> new ShellItemPropertyKey(new Guid("{A9EA193C-C511-498A-A06B-58E2776DCC28}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PeopleNames
					=> new ShellItemPropertyKey(new Guid("{E8309B6E-084C-49B4-B1FC-90A80331B638}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PhotometricInterpretation
					=> new ShellItemPropertyKey(new Guid("{341796F1-1DF9-4B1C-A564-91BDEFA43877}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PhotometricInterpretationText
					=> new ShellItemPropertyKey(new Guid("{821437D6-9EAB-4765-A589-3B1CBBD22A61}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ProgramMode
					=> new ShellItemPropertyKey(new Guid("{6D217F6D-3F6A-4825-B470-5F03CA2FBE9B}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ProgramModeText
					=> new ShellItemPropertyKey(new Guid("{7FE3AA27-2648-42F3-89B0-454E5CB150C3}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey RelatedSoundFile
					=> new ShellItemPropertyKey(new Guid("{318A6B45-087F-4DC2-B8CC-05359551FC9E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Saturation
					=> new ShellItemPropertyKey(new Guid("{49237325-A95A-4F67-B211-816B2D45D2E0}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SaturationText
					=> new ShellItemPropertyKey(new Guid("{61478C08-B600-4A84-BBE4-E99C45F0A072}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Sharpness
					=> new ShellItemPropertyKey(new Guid("{FC6976DB-8349-4970-AE97-B3C5316A08F0}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SharpnessText
					=> new ShellItemPropertyKey(new Guid("{51EC3F47-DD50-421D-8769-334F50424B1E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ShutterSpeed
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 37377);
				...
				/// </summary>
				public static ShellItemPropertyKey ShutterSpeedDenominator
					=> new ShellItemPropertyKey(new Guid("{E13D8975-81C7-4948-AE3F-37CAE11E8FF7}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ShutterSpeedNumerator
					=> new ShellItemPropertyKey(new Guid("{16EA4042-D6F4-4BCA-8349-7C78D30FB333}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SubjectDistance
					=> new ShellItemPropertyKey(new Guid("{14B81DA1-0135-4D31-96D9-6CBFC9671A99}"), 37382);
				...
				/// </summary>
				public static ShellItemPropertyKey SubjectDistanceDenominator
					=> new ShellItemPropertyKey(new Guid("{0C840A88-B043-466D-9766-D4B26DA3FA77}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey SubjectDistanceNumerator
					=> new ShellItemPropertyKey(new Guid("{8AF4961C-F526-43E5-AA81-DB768219178D}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TagViewAggregate
					=> new ShellItemPropertyKey(new Guid("{B812F15D-C2D8-4BBF-BACD-79744346113F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey TranscodedForSync
					=> new ShellItemPropertyKey(new Guid("{9A8EBB75-6458-4E82-BACB-35C0095B03BB}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey WhiteBalance
					=> new ShellItemPropertyKey(new Guid("{EE3D3D8A-5381-4CFA-B13B-AAF66B5F4EC9}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey WhiteBalanceText
					=> new ShellItemPropertyKey(new Guid("{6336B95E-C7A7-426D-86FD-7AE3D39C84B4}"), 100);
			}
			...
			public static class PropGroup
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Advanced
					=> new ShellItemPropertyKey(new Guid("{900A403B-097B-4B95-8AE2-071FDAEEB118}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Audio
					=> new ShellItemPropertyKey(new Guid("{2804D469-788F-48AA-8570-71B9C187E138}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Calendar
					=> new ShellItemPropertyKey(new Guid("{9973D2B5-BFD8-438A-BA94-5349B293181A}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Camera
					=> new ShellItemPropertyKey(new Guid("{DE00DE32-547E-4981-AD4B-542F2E9007D8}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Contact
					=> new ShellItemPropertyKey(new Guid("{DF975FD3-250A-4004-858F-34E29A3E37AA}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Content
					=> new ShellItemPropertyKey(new Guid("{D0DAB0BA-368A-4050-A882-6C010FD19A4F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Description
					=> new ShellItemPropertyKey(new Guid("{8969B275-9475-4E00-A887-FF93B8B41E44}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey FileSystem
					=> new ShellItemPropertyKey(new Guid("{E3A7D2C1-80FC-4B40-8F34-30EA111BDC2E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey General
					=> new ShellItemPropertyKey(new Guid("{CC301630-B192-4C22-B372-9F4C6D338E07}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey GPS
					=> new ShellItemPropertyKey(new Guid("{F3713ADA-90E3-4E11-AAE5-FDC17685B9BE}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Image
					=> new ShellItemPropertyKey(new Guid("{E3690A87-0FA8-4A2A-9A9F-FCE8827055AC}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Media
					=> new ShellItemPropertyKey(new Guid("{61872CF7-6B5E-4B4B-AC2D-59DA84459248}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey MediaAdvanced
					=> new ShellItemPropertyKey(new Guid("{8859A284-DE7E-4642-99BA-D431D044B1EC}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Message
					=> new ShellItemPropertyKey(new Guid("{7FD7259D-16B4-4135-9F97-7C96ECD2FA9E}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Music
					=> new ShellItemPropertyKey(new Guid("{68DD6094-7216-40F1-A029-43FE7127043F}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Origin
					=> new ShellItemPropertyKey(new Guid("{2598D2FB-5569-4367-95DF-5CD3A177E1A5}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PhotoAdvanced
					=> new ShellItemPropertyKey(new Guid("{0CB2BF5A-9EE7-4A86-8222-F01E07FDADAF}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey RecordedTV
					=> new ShellItemPropertyKey(new Guid("{E7B33238-6584-4170-A5C0-AC25EFD9DA56}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Video
					=> new ShellItemPropertyKey(new Guid("{BEBE0920-7671-4C54-A3EB-49FDDFC191EE}"), 100);
			}
			...
			public static class PropList
			{
				...
				/// </summary>
				public static ShellItemPropertyKey ConflictPrompt
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 11);
				...
				/// </summary>
				public static ShellItemPropertyKey ContentViewModeForBrowse
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 13);
				...
				/// </summary>
				public static ShellItemPropertyKey ContentViewModeForSearch
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 14);
				...
				/// </summary>
				public static ShellItemPropertyKey ExtendedTileInfo
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey FileOperationPrompt
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 10);
				...
				/// </summary>
				public static ShellItemPropertyKey FullDetails
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey InfoTip
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey NonPersonal
					=> new ShellItemPropertyKey(new Guid("{49D1091F-082E-493F-B23F-D2308AA9668C}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey PreviewDetails
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey PreviewTitle
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey QuickTip
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey TileInfo
					=> new ShellItemPropertyKey(new Guid("{C9944A21-A406-48FE-8225-AEC7E24C211B}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey XPDetailsPanel
					=> new ShellItemPropertyKey(new Guid("{F2275480-F782-4291-BD94-F13693513AEC}"), 0);
			}
			...
			public static class RecordedTV
			{
				...
				/// </summary>
				public static ShellItemPropertyKey ChannelNumber
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 7);
				...
				/// </summary>
				public static ShellItemPropertyKey Credits
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey DateContentExpires
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 15);
				...
				/// </summary>
				public static ShellItemPropertyKey EpisodeName
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey IsATSCContent
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 16);
				...
				/// </summary>
				public static ShellItemPropertyKey IsClosedCaptioningAvailable
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 12);
				...
				/// </summary>
				public static ShellItemPropertyKey IsDTVContent
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 17);
				...
				/// </summary>
				public static ShellItemPropertyKey IsHDContent
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 18);
				...
				/// </summary>
				public static ShellItemPropertyKey IsRepeatBroadcast
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 13);
				...
				/// </summary>
				public static ShellItemPropertyKey IsSAP
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 14);
				...
				/// </summary>
				public static ShellItemPropertyKey NetworkAffiliation
					=> new ShellItemPropertyKey(new Guid("{2C53C813-FB63-4E22-A1AB-0B331CA1E273}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey OriginalBroadcastDate
					=> new ShellItemPropertyKey(new Guid("{4684FE97-8765-4842-9C13-F006447B178C}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey ProgramDescription
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey RecordingTime
					=> new ShellItemPropertyKey(new Guid("{A5477F61-7A82-4ECA-9DDE-98B69B2479B3}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey StationCallSign
					=> new ShellItemPropertyKey(new Guid("{6D748DE2-8D38-4CC3-AC60-F009B057C557}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey StationName
					=> new ShellItemPropertyKey(new Guid("{1B5439E7-EBA1-4AF8-BDD7-7AF1D4549493}"), 100);
			}
			...
			public static class Search
			{
				...
				/// </summary>
				public static ShellItemPropertyKey AutoSummary
					=> new ShellItemPropertyKey(new Guid("{560C36C0-503A-11CF-BAA1-00004C752A9A}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey ContainerHash
					=> new ShellItemPropertyKey(new Guid("{BCEEE283-35DF-4D53-826A-F36A3EEFC6BE}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Contents
					=> new ShellItemPropertyKey(new Guid("{B725F130-47EF-101A-A5F1-02608C9EEBAC}"), 19);
				...
				/// </summary>
				public static ShellItemPropertyKey EntryID
					=> new ShellItemPropertyKey(new Guid("{49691C90-7E17-101A-A91C-08002B2ECDA9}"), 5);
				...
				/// </summary>
				public static ShellItemPropertyKey ExtendedProperties
					=> new ShellItemPropertyKey(new Guid("{7B03B546-FA4F-4A52-A2FE-03D5311E5865}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey GatherTime
					=> new ShellItemPropertyKey(new Guid("{0B63E350-9CCC-11D0-BCDB-00805FCCCE04}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey HitCount
					=> new ShellItemPropertyKey(new Guid("{49691C90-7E17-101A-A91C-08002B2ECDA9}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey IsClosedDirectory
					=> new ShellItemPropertyKey(new Guid("{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}"), 23);
				...
				/// </summary>
				public static ShellItemPropertyKey IsFullyContained
					=> new ShellItemPropertyKey(new Guid("{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}"), 24);
				...
				/// </summary>
				public static ShellItemPropertyKey QueryFocusedSummary
					=> new ShellItemPropertyKey(new Guid("{560C36C0-503A-11CF-BAA1-00004C752A9A}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey QueryFocusedSummaryWithFallback
					=> new ShellItemPropertyKey(new Guid("{560C36C0-503A-11CF-BAA1-00004C752A9A}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey Rank
					=> new ShellItemPropertyKey(new Guid("{49691C90-7E17-101A-A91C-08002B2ECDA9}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey Store
					=> new ShellItemPropertyKey(new Guid("{A06992B3-8CAF-4ED7-A547-B259E32AC9FC}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey UrlToIndex
					=> new ShellItemPropertyKey(new Guid("{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey UrlToIndexWithModificationTime
					=> new ShellItemPropertyKey(new Guid("{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}"), 12);
			}
			...
			public static class Shell
			{
				...
				/// </summary>
				public static ShellItemPropertyKey OmitFromView
					=> new ShellItemPropertyKey(new Guid("{DE35258C-C695-4CBC-B982-38B0AD24CED0}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey SFGAOFlagsStrings
					=> new ShellItemPropertyKey(new Guid("{D6942081-D53B-443D-AD47-5E059D9CD27A}"), 2);
			}
			...
			public static class Software
			{
				...
				/// </summary>
				public static ShellItemPropertyKey DateLastUsed
					=> new ShellItemPropertyKey(new Guid("{841E4F90-FF59-4D16-8947-E81BBFFAB36D}"), 16);
				...
				/// </summary>
				public static ShellItemPropertyKey ProductName
					=> new ShellItemPropertyKey(new Guid("{0CEF7D53-FA64-11D1-A203-0000F81FEDEE}"), 7);
			}
			...
			public static class Sync
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Comments
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 13);
				...
				/// </summary>
				public static ShellItemPropertyKey ConflictDescription
					=> new ShellItemPropertyKey(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey ConflictFirstLocation
					=> new ShellItemPropertyKey(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey ConflictSecondLocation
					=> new ShellItemPropertyKey(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 7);
				...
				/// </summary>
				public static ShellItemPropertyKey HandlerCollectionID
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey HandlerID
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey HandlerName
					=> new ShellItemPropertyKey(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey HandlerType
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey HandlerTypeLabel
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey ItemID
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey ItemName
					=> new ShellItemPropertyKey(new Guid("{CE50C159-2FB8-41FD-BE68-D3E042E274BC}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey ProgressPercentage
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 23);
				...
				/// </summary>
				public static ShellItemPropertyKey State
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 24);
				...
				/// </summary>
				public static ShellItemPropertyKey Status
					=> new ShellItemPropertyKey(new Guid("{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}"), 10);
			}
			...
			public static class Task
			{
				...
				/// </summary>
				public static ShellItemPropertyKey BillingInformation
					=> new ShellItemPropertyKey(new Guid("{D37D52C6-261C-4303-82B3-08B926AC6F12}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey CompletionStatus
					=> new ShellItemPropertyKey(new Guid("{084D8A0A-E6D5-40DE-BF1F-C8820E7C877C}"), 100);
				...
				/// </summary>
				public static ShellItemPropertyKey Owner
					=> new ShellItemPropertyKey(new Guid("{08C7CC5F-60F2-4494-AD75-55E3E0B5ADD0}"), 100);
			}
			...
			public static class Video
			{
				...
				/// </summary>
				public static ShellItemPropertyKey Compression
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 10);
				...
				/// </summary>
				public static ShellItemPropertyKey Director
					=> new ShellItemPropertyKey(new Guid("{64440492-4C8B-11D1-8B70-080036B11A03}"), 20);
				...
				/// </summary>
				public static ShellItemPropertyKey EncodingBitrate
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 8);
				...
				/// </summary>
				public static ShellItemPropertyKey FourCC
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 44);
				...
				/// </summary>
				public static ShellItemPropertyKey FrameHeight
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey FrameRate
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 6);
				...
				/// </summary>
				public static ShellItemPropertyKey FrameWidth
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 3);
				...
				/// </summary>
				public static ShellItemPropertyKey HorizontalAspectRatio
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 42);
				...
				/// </summary>
				public static ShellItemPropertyKey SampleSize
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 9);
				...
				/// </summary>
				public static ShellItemPropertyKey StreamName
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey StreamNumber
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 11);
				...
				/// </summary>
				public static ShellItemPropertyKey TotalBitrate
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 43);
				...
				/// </summary>
				public static ShellItemPropertyKey TranscodedForSync
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 46);
				...
				/// </summary>
				public static ShellItemPropertyKey VerticalAspectRatio
					=> new ShellItemPropertyKey(new Guid("{64440491-4C8B-11D1-8B70-080036B11A03}"), 45);
			}
			...
			public static class Volume
			{
				...
				/// </summary>
				public static ShellItemPropertyKey FileSystem
					=> new ShellItemPropertyKey(new Guid("{9B174B35-40FF-11D2-A27E-00C04FC30871}"), 4);
				...
				/// </summary>
				public static ShellItemPropertyKey IsMappedDrive
					=> new ShellItemPropertyKey(new Guid("{149C0B69-2C2D-48FC-808F-D318D78C4636}"), 2);
				...
				/// </summary>
				public static ShellItemPropertyKey IsRoot
					=> new ShellItemPropertyKey(new Guid("{9B174B35-40FF-11D2-A27E-00C04FC30871}"), 10);
			}
		}
		...
		public static class ShellUtil
		{
			...
			public static IShellItem GetShellItemForPath(string path)
			{
				...
				object unk;
				SHCreateItemFromParsingName(path, null, Marshal.GenerateGuidForType(typeof(IShellItem)), out unk);
				return (IShellItem)unk;
			}

			public static KNOWNFOLDERID_Enum GetKnownFolderFromGuid(Guid knownFolder)
			{
				return Enum.GetValues(typeof(KNOWNFOLDERID_Enum)).Cast<KNOWNFOLDERID_Enum>().Single(k => k.Guid() == knownFolder);
			}

			public static KNOWNFOLDERID_Enum GetKnownFolderFromPath(string path)
			{
				if (Environment.OSVersion.Version.Major < 6)
					return Enum.GetValues(typeof(KNOWNFOLDERID_Enum)).Cast<KNOWNFOLDERID_Enum>().Single(k => string.Equals(k.FullPath(), path, StringComparison.InvariantCultureIgnoreCase));

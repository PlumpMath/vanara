...
{
	/// <summary>Extension methods for <see cref="Shell32.KNOWNFOLDERID_Enum"/>.</summary>
	public static class KnownFolderIdExt
	{
		private const string RegPath = @"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FolderDescriptions\";
		private const Shell32.KNOWN_FOLDER_FLAG stdGetFlags = Shell32.KNOWN_FOLDER_FLAG.KF_FLAG_DEFAULT_PATH | Shell32.KNOWN_FOLDER_FLAG.KF_FLAG_NOT_PARENT_RELATIVE | Shell32.KNOWN_FOLDER_FLAG.KF_FLAG_NO_ALIAS | Shell32.KNOWN_FOLDER_FLAG.KF_FLAG_DONT_VERIFY;
		...
		{
			if (spFolder == Environment.SpecialFolder.Personal) return Shell32.KNOWNFOLDERID_Enum.FOLDERID_Documents;
			if (spFolder == Environment.SpecialFolder.DesktopDirectory) return Shell32.KNOWNFOLDERID_Enum.FOLDERID_Desktop;
		...
		/// <summary>Retrieves the name associated with a <see cref="Shell32.KNOWNFOLDERID_Enum"/>.</summary>
		/// <param name="id">The known folder.</param>
		/// <returns>The name.</returns>
		public static string Name(this Shell32.KNOWNFOLDERID_Enum id) => id.GetRegistryProperty<string>("Name");
	...
	public static partial class Shell32
	{
		...
		/// see CSIDL.
		/// </summary>
		public enum KNOWNFOLDERID_Enum
		{
			...
			[KnownFolderDetail("{724EF170-A42D-4FEF-9F26-B60E846FBA4F}", Equivalent = Environment.SpecialFolder.AdminTools)]
			FOLDERID_AdminTools,
			...
			[KnownFolderDetail("{9E52AB10-F80D-49DF-ACB8-4330F5687855}", Equivalent = Environment.SpecialFolder.CDBurning)]
			FOLDERID_CDBurning,
			...
			[KnownFolderDetail("{D0384E7D-BAC3-4797-8F14-CBA229B392B5}", Equivalent = Environment.SpecialFolder.CommonAdminTools)]
			FOLDERID_CommonAdminTools,

			/// <summary>OEM Links</summary>
			[KnownFolderDetail("{C1BAE2D0-10DF-4334-BEDD-7AA20B227A9D}", Equivalent = Environment.SpecialFolder.CommonOemLinks)]
			FOLDERID_CommonOEMLinks,

			/// <summary>Programs</summary>
			[KnownFolderDetail("{0139D44E-6AFE-49F2-8690-3DAFCAE6FFB8}", Equivalent = Environment.SpecialFolder.CommonPrograms)]
			FOLDERID_CommonPrograms,

			/// <summary>Start Menu</summary>
			[KnownFolderDetail("{A4115719-D62E-491D-AA7C-E74B8BE3B067}", Equivalent = Environment.SpecialFolder.CommonStartMenu)]
			FOLDERID_CommonStartMenu,

			/// <summary>Startup</summary>
			[KnownFolderDetail("{82A5EA35-D9CD-47C5-9629-E15D2F714E6E}", Equivalent = Environment.SpecialFolder.CommonStartup)]
			FOLDERID_CommonStartup,

			/// <summary>Templates</summary>
			[KnownFolderDetail("{B94237E7-57AC-4347-9151-B08C6C32D1F7}", Equivalent = Environment.SpecialFolder.CommonTemplates)]
			...
			[KnownFolderDetail("{FD228CB7-AE11-4AE3-864C-16F3910AB8FE}", Equivalent = Environment.SpecialFolder.Fonts)]
			FOLDERID_Fonts,
			...
			[KnownFolderDetail("{2A00375E-224C-49DE-B8D1-440DF7EF3DDC}", Equivalent = Environment.SpecialFolder.LocalizedResources)]
			...
			[KnownFolderDetail("{C5ABBF53-E17F-4121-8900-86626FC2C973}", Equivalent = Environment.SpecialFolder.NetworkShortcuts)]
			FOLDERID_NetHood,
			...
			[KnownFolderDetail("{9274BD8D-CFD1-41C3-B35E-B13F55A758F4}", Equivalent = Environment.SpecialFolder.PrinterShortcuts)]
			FOLDERID_PrintHood,

			/// <summary>The user's username (%USERNAME%)</summary>
			[KnownFolderDetail("{5E6C858F-0E22-4760-9AFE-EA3317B67173}", Equivalent = Environment.SpecialFolder.UserProfile)]
			FOLDERID_Profile,
			...
			/// <summary>Program Files</summary>
			[KnownFolderDetail("{7C5A40EF-A0FB-4BFC-874A-C0F2E0B9FA8E}", Equivalent = Environment.SpecialFolder.ProgramFilesX86)]
			...
			/// <summary>Common Files</summary>
			[KnownFolderDetail("{DE974D24-D9C6-4D3E-BF91-F4455120B917}", Equivalent = Environment.SpecialFolder.CommonProgramFilesX86)]
			...
			[KnownFolderDetail("{C4AA340D-F20F-4863-AFEF-F87EF2E6BA25}", Equivalent = Environment.SpecialFolder.CommonDesktopDirectory)]
			FOLDERID_PublicDesktop,

			/// <summary>Public Documents</summary>
			[KnownFolderDetail("{ED4824AF-DCE4-45A8-81E2-FC7965083634}", Equivalent = Environment.SpecialFolder.CommonDocuments)]
			...
			[KnownFolderDetail("{3214FAB5-9757-4298-BB61-92A9DEAA44FF}", Equivalent = Environment.SpecialFolder.CommonMusic)]
			FOLDERID_PublicMusic,

			/// <summary>Public Pictures</summary>
			[KnownFolderDetail("{B6EBFB86-6907-413C-9AF7-4FC2ABF07CC5}", Equivalent = Environment.SpecialFolder.CommonPictures)]
			...
			[KnownFolderDetail("{2400183A-6185-49FB-A2D8-4A392A602BA3}", Equivalent = Environment.SpecialFolder.CommonVideos)]
			...
			[KnownFolderDetail("{8AD10C31-2ADB-4296-A8F7-E4701232C972}", Equivalent = Environment.SpecialFolder.Resources)]
			...
			/// <summary>System32</summary>
			[KnownFolderDetail("{D65231B0-B2F1-4857-A4CE-A8E7C6EA7D27}", Equivalent = Environment.SpecialFolder.SystemX86)]
			FOLDERID_SystemX86,
			...
			[KnownFolderDetail("{18989B1D-99B5-455B-841C-AB7C74E4DDFC}", Equivalent = Environment.SpecialFolder.MyVideos)]
			FOLDERID_Videos,
			...
			[KnownFolderDetail("{F38BF404-1D43-42F2-9305-67DE0B28FC23}", Equivalent = Environment.SpecialFolder.Windows)]
			FOLDERID_Windows,
		}

		/// <summary>Provides information about a <see cref="KNOWNFOLDERID_Enum"/>.</summary>
		...
		internal class KnownFolderDetailAttribute : Attribute
		{
			...
			/// <summary>Initializes a new instance of the <see cref="KnownFolderDetailAttribute"/> class with a GUID for the <see cref="KNOWNFOLDERID_Enum"/>.</summary>
			/// <param name="knownFolderGuid">The GUID for the <see cref="KNOWNFOLDERID_Enum"/>.</param>

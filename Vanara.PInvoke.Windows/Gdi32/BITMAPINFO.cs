...
namespace Vanara.PInvoke
{
	public static partial class Gdi32
	{
		...
		/// </remarks>
		[DllImport(nameof(Gdi32), ExactSpelling = true, SetLastError = true)]
		public static extern int GetDIBits(Gdi32.SafeDCHandle hdc, IntPtr hbmp, int uStartScan, int cScanLines, ref byte[] lpvBits, ref Gdi32.BITMAPINFO lpbi, DIBColorMode uUsage);

...
namespace Vanara.PInvoke
{
	public static partial class Gdi32
	{
		...
		public class SafeDCHandle : SafeHandle
		{
			...
			/// </param>
			public SafeDCHandle(IntPtr hDC, bool ownsHandle = true) : base(IntPtr.Zero, ownsHandle)
			{
				SetHandle(hDC);
			}
			...
			public SafeDCHandle(IDeviceContext dc) : base(IntPtr.Zero, true)
			{
				if (dc == null) return;
				idc = dc;
				SetHandle(dc.GetHdc());
			...
			/// <summary>
			/// Performs an explicit conversion from <see cref="SafeDCHandle" /> to <see cref="Graphics" />.
			/// </summary>

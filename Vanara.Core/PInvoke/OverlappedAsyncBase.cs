...
namespace Vanara.PInvoke
{
	...
	public static class OverlappedAsync
	{
		...
		public static object EndOverlappedFunction(IAsyncResult asyncResult)
		{
			...
			var result = asyncResult as OverlappedAsyncResult;
			if (result == null)
			...
			if (handle != null && !handle.SafeWaitHandle.IsClosed)
				try
				{
					handle.WaitOne();
				}
		...
		public static unsafe OverlappedAsyncResult SetupOverlappedFunction(SafeFileHandle hDevice,

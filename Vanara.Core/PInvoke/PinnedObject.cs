...
namespace Vanara.PInvoke
{
	...
	public class PinnedObject : IDisposable
	{
		...
		public static implicit operator IntPtr(PinnedObject ap) => ap.pinnedArray.IsAllocated ? new IntPtr(ap.pinnedArray.AddrOfPinnedObject().ToInt64() + ap.mOffset) : IntPtr.Zero;

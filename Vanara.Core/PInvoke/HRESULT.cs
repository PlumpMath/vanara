...
namespace Vanara.PInvoke
{
    ...
    public partial struct HRESULT : IComparable, IComparable<HRESULT>, IEquatable<HRESULT>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HRESULT"/> structure.
        /// </summary>
        ...
        public int CompareTo(object obj)
        {
            ...
            return v.HasValue ? _value.CompareTo(v.Value) : -1;
        }
        ...
        public override bool Equals(object obj)
        {
            try
            {
                return _value == ValueFromObj(obj);
            }
            catch
            {
                // ignored
        ...
        /// <param name="code">The code.</param>
        /// <returns>The resulting <see cref="HRESULT"/>.</returns>
        public static HRESULT Make(bool severe, uint facility, uint code) => new HRESULT((severe ? severityMask : 0) | (facility << facilityShift) | code);
        ...
        public override string ToString()
        {
            ...
            return string.Format(CultureInfo.InvariantCulture, "0x{0:X8}", new[] {_value});
        }

...
namespace Vanara.Collections
{
	...
	public class EventedList<T> : IList<T>, IList where T : INotifyPropertyChanged
	{
		...
		/// <summary>
		/// Copies the elements of the <see cref="ICollection{T}"/> to an <see
		...
		/// copied from <see cref="ICollection{T}"/>. The <see cref="T:System.Array"/> must have
		/// zero-based indexing.
		/// </param>
		...
		/// <paramref name="arrayIndex"/> to the end of the destination <paramref
		/// name="array"/>.-or-Type <c>T</c> cannot be cast automatically to the type of the
		...
		/// cref="ICollection{T}"/>; otherwise, false. This method also returns false if <paramref
		/// name="item"/> is not found in the original <see cref="ICollection{T}"/>.
		/// </returns>
		/// <exception cref="T:System.NotSupportedException">
		/// The <see cref="ICollection{T}"/> is read-only.
		/// </exception>
		...
		/// <summary>
		/// Searches the entire sorted <see cref="EventedList{T}"/> for an element using the default
		/// comparer and returns the zero-based index of the element.
		/// </summary>
		/// <param name="item">The object to locate. The value can be null for reference types.</param>
		/// <returns>
		/// The zero-based index of item in the sorted <see cref="EventedList{T}"/>, if item is
		/// found; otherwise, a negative number that is the bitwise complement of the index of the
		...
		/// <summary>
		/// Searches the entire sorted <see cref="EventedList{T}"/> for an element using the
		...
		/// <summary>
		/// Searches a range of elements in the sorted <see cref="EventedList{T}"/> for an element
...
#pragma warning disable 693
		public class ListChangedEventArgs<T> : EventArgs
		{
			...
			/// cref="EventedList{T}.ListChangedEventArgs{T}"/> class.
			/// </summary>
